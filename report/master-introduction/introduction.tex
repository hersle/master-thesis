...
\TODO{NO! believed to be superconducting phase along $\mu_Q$-axis}
...
\TODO{emphasize that one central pressure corresponds to one mass and one radius?}
...
\caption{%
	...
	\TODO{more complicated phase diagram}
...
\TODO{JO suggests $\mu$ since $\mu_Q$ can refer to charge chemical potential. some use $\mu_q$}
\begin{equation}
...
\TODO{refer to colorless states as ``color singlet''?}
...
\TODO{round off with magnet analogy: adding $B$ explicitly breaks symmetry and essentially generates massive ``quarks''}
