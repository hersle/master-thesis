...
With massless quarks, the Lagrangian \eqref{eq:qcd:lagrangian} can be written
\begin{equation}
...
\subsubsection{Linear sigma model (quark-meson model)}
...
\TODO{qcd phase diagram picture}
