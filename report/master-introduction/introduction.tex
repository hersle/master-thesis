...
\TODO{note to self for later: get very different $B$ in LSM compared to MIT, but this is because meson potential contributes to effective bag pressure before the crossover, and \emph{this} bag pressure is comparable to these bag windows?}
...
\TODO{%
	...
	subtitle ``Including detailed introduction to the Tolman-Oppenheimer-Volkoff equation, thermal field theory and ideal neutron stars''
}
...
\TODO{Kyllingstad has a more applicable phase diagram?}
...
\caption{\label{tab:qcd:quark_properties}%
	...
	\TODO{sources? used Glendenning for lone masses. what about $s$ quark?}
}
\end{table}
