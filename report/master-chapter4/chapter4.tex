...
\TODO{les intro igjen med confinement osv.}
...
\nextgroupplot[
	title = {Two-flavor equations of state},
	ylabel = {$\epsilon \, / \, (\si{\giga\electronvolt\per\femto\meter\cubed})$},
];
\addplot [red, solid] table [x=P, y=epsilon] {../code/data/LSM2F_APR/eos_sigma_600.dat};
\addlegendentry{$m_\sigma=\SI{600}{\mega\electronvolt}$, $B^\frac14 = \SI{111}{\mega\electronvolt}$};
\addplot [darkgreen, dashed] table [x=P, y=epsilon] {../code/data/LSM2F_APR/eos_sigma_700.dat};
\addlegendentry{$m_\sigma=\SI{700}{\mega\electronvolt}$, $B^\frac14 = \phantom{0}\SI{68}{\mega\electronvolt}$};
\addplot [blue, dotted] table [x=P, y=epsilon] {../code/data/LSM2F_APR/eos_sigma_800.dat};
\addlegendentry{$m_\sigma=\SI{800}{\mega\electronvolt}$, $B^\frac14 = \phantom{0}\SI{27}{\mega\electronvolt}$};

\nextgroupplot[
	title = {Three-flavor equations of state},
];
...
\caption{\label{fig:hybrid:eos-all}%
	...
	with the two-flavor and three-flavor quark-meson models.
}
\end{figure}

\Cref{fig:hybrid:eos} shows the step-by-step construction of the hybrid equation of state
...
\end{groupplot}
\node (title) at ($(group c1r1.north west)!0.5!(group c2r1.north east)$) [above, yshift=\pgfkeysvalueof{/pgfplots/every axis title shift}] {Two-flavor hybrid star mass-radius solutions};
\end{tikzpicture}
...
\end{groupplot}
\node (title) at ($(group c1r1.north west)!0.5!(group c2r1.north east)$) [above, yshift=\pgfkeysvalueof{/pgfplots/every axis title shift}] {Three-flavor hybrid star mass-radius solutions};
\end{tikzpicture}
...
\item In fact, \cite[equation 15]{ref:hybrid_star_stability_criterion} shows that under general circumstances and no matter how small the quark core is,
      ...
      This shows that criterion \eqref{eq:hybrid:stability_criterion} is consistent with our findings. \TODO{les}
...
\addlegendentry{$m_\sigma=\SI{400}{\mega\electronvolt}$, $B^\frac14 = \SI{107}{\mega\electronvolt}$};
\addplot [darkgreen, dashed] table [x=P, y=epsilon] {../code/data/LSM2FC_APR/eos_sigma_500.dat};
\addlegendentry{$m_\sigma=\SI{500}{\mega\electronvolt}$, $B^\frac14 = \phantom{0}\SI{84}{\mega\electronvolt}$};
\addplot [blue, dotted] table [x=P, y=epsilon] {../code/data/LSM2FC_APR/eos_sigma_600.dat};
\addlegendentry{$m_\sigma=\SI{600}{\mega\electronvolt}$, $B^\frac14 = \phantom{0}\SI{27}{\mega\electronvolt}$};
\end{groupplot}
\end{tikzpicture}
...
\draw [Latex-] (11.45,2.09) -- (15.0,2.20) node [anchor=west] {$m_\sigma=\SI{600}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{27}{\mega\electronvolt}$};
\draw [Latex-] (11.55,2.01) -- (15.0,2.00) node [anchor=west] {$m_\sigma=\SI{500}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{84}{\mega\electronvolt}$};
\draw [Latex-] (11.65,1.98) -- (15.0,1.80) node [anchor=west] {$m_\sigma=\SI{400}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{107}{\mega\electronvolt}$};
...
\begin{figure}
\centering
\tikzsetnextfilename{hybrid-2-flavor-consistent-super}
\begin{tikzpicture}
\begin{groupplot}[
...
\nextgroupplot[
	...
	ylabel = {$\epsilon \, / \, (\si{\giga\electronvolt\per\femto\meter\cubed})$},
	xmin=0, ymin=0, xmax=0.5, ymax=3.5, restrict x to domain=-1:+4, restrict y to domain=-1:+4, xtick distance=0.1,
	grid = both, minor grid style = {ultra thin},
];
\addplot [red, solid] table [x=P, y=epsilon] {../code/data/LSM2FC_APR/eos_sigma_400.dat};
\addlegendentry{$m_\sigma=\SI{400}{\mega\electronvolt}$, $B^\frac14 = \SI{107}{\mega\electronvolt}$};
\addplot [darkgreen, dashed] table [x=P, y=epsilon] {../code/data/LSM2FC_APR/eos_sigma_500.dat};
...
\nextgroupplot[
	point meta=explicit, point meta min=33, point meta max=36,
	%colorbar horizontal, colormap name=plasmarev, colorbar style={xlabel=$\log_{10} (P_c \, / \, \si{\pascal})$, xtick distance=1, minor x tick num=9, at={(0.5,1.03)}, anchor=south, xticklabel pos=upper},
	xmin=10, xmax=15, ymin=0.25, ymax=2.75,
	legend pos = north west, legend cell align = right, legend columns = 2,
]
\addplot [name path=J0748lo, draw=none, forget plot, domain=0:40] {2.08 - 0.07};
\addplot [name path=J0748hi, draw=none, forget plot, domain=0:40] {2.08 + 0.07};
\addplot [red, opacity=0.4, forget plot] fill between [of=J0748lo and J0748hi]; % \addlegendentry{PSR J0748$+$6620};

\addplot [name path=J0348lo, draw=none, forget plot, domain=0:40] {2.01 - 0.04};
\addplot [name path=J0348hi, draw=none, forget plot, domain=0:40] {2.01 + 0.04};
\addplot [green, opacity=0.4, forget plot] fill between [of=J0348lo and J0348hi]; % \addlegendentry{PSR J0348$+$0432};

\addplot [name path=J1614lo, draw=none, forget plot, domain=0:40] {1.91 - 0.02};
\addplot [name path=J1614hi, draw=none, forget plot, domain=0:40] {1.91 + 0.02};
\addplot [yellow, opacity=0.4, forget plot] fill between [of=J1614lo and J1614hi]; % \addlegendentry{PSR J1614$-$2230};

\addplot+ [solid, gray] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_hadron.dat}; \addlegendentry{neutron stars};
\addplot+ [solid, mesh, mesh line legend] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC_APR/stars_sigma_400_B14_107.dat}; \addlegendentry{hybrid stars};
\addplot+ [solid, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC_APR/stars_sigma_500_B14_84.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC_APR/stars_sigma_600_B14_27.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\draw [Latex-] (11.35,2.09) -- (11.8,2.20) node [anchor=west] {$\{m_\sigma,B^\frac14\}=\{600,27\} \, \si{\mega\electronvolt}$};
\draw [Latex-] (11.45,2.00) -- (11.8,2.00) node [anchor=west] {$\{m_\sigma,B^\frac14\}=\{500,84\} \, \si{\mega\electronvolt}$};
\draw [Latex-] (11.50,1.96) -- (11.8,1.80) node [anchor=west] {$\{m_\sigma,B^\frac14\}=\{400,107\} \, \si{\mega\electronvolt}$};
\coordinate (zoomplot) at (13.0, 0.2);
\node[scale=0.75] at (11.216, 1.996) {\goldenstar};
...
\node [anchor=south west] at (zoomplot) {
	...
	\begin{axis}[
		...
		ymin=1.85, ymax=2.15, xmin=11, xmax=12,
	...
	\addplot+ [solid, gray] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_hadron.dat};
	\addplot+ [solid, mesh, mesh line legend] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC_APR/stars_sigma_400_B14_107.dat};
	\addplot+ [solid, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC_APR/stars_sigma_500_B14_84.dat};
	\addplot+ [solid, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC_APR/stars_sigma_600_B14_27.dat};
	\end{axis}
	\end{tikzpicture}
};
\end{tikzpicture}
