...
\addplot+ [red, solid, very thick] table [x=muB2,y=P] {../code/data/LSM3F_APR/eos_sigma_600.dat}; \addlegendentry{quark phase};
\addplot+ [blue, solid, very thick] table [x=muB1,y=P1] {../code/data/LSM3F_APR/eos_sigma_600.dat}; \addlegendentry{hadron phase};
\addplot+ [black, dashed, very thick] table [x=muB,y=P] {../code/data/LSM3F_APR/eos_sigma_600.dat}; \addlegendentry{hybrid phase};
...
\addplot+ [blue, solid, very thick] table [x=muB1,y expr={\thisrow{nB1}/0.165}] {../code/data/LSM3F_APR/eos_sigma_600.dat};
...
\addplot+ [blue, solid, very thick] table [x=P1,y=epsilon1] {../code/data/LSM3F_APR/eos_sigma_600.dat};
...
\TODO{ref to appendix with numerical implementation}
...
\draw [Latex-] (11.35,2.06) -- (15.0,2.20) node [anchor=west] {$m_\sigma=\SI{800}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{27}{\mega\electronvolt}$};
\draw [Latex-] (11.45,1.96) -- (15.0,2.00) node [anchor=west] {$m_\sigma=\SI{700}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{68}{\mega\electronvolt}$};
\draw [Latex-] (11.55,1.89) -- (15.0,1.80) node [anchor=west] {$m_\sigma=\SI{600}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{111}{\mega\electronvolt}$};
\node[scale=0.75] at (11.23, 2.06) {\goldenstar};

\nextgroupplot[
	width=5cm, 
	xlabel={$R \, / \, \si{\kilo\meter}$},
	xmin=10, xmax=12, ymin=1.8, ymax=2.1, xtick distance=1, ytick distance=0.1, minor tick num=9, grid=major,
	%title = {$m_\sigma = \SI{600}{\mega\electronvolt}$, $B^\frac14 = \SI{111}{\mega\electronvolt}$ },
	legend columns=2, legend style={anchor=north, at={(0.5, 0.96)}},
];
\addplot+ [solid, gray] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_hadron.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
...
\addplot+ [red, x filter/.expression={\thisrow{r}<1.7 ? x : nan}] table [x=r, y=nu] {../code/data/LSM3F_APR/star_sigma_800_B14_27_Pc_0.0012587.dat}; \addlegendentry{$n_u$};
\addplot+ [darkgreen, x filter/.expression={\thisrow{r}<1.7 ? x : nan}] table [x=r, y=nd] {../code/data/LSM3F_APR/star_sigma_800_B14_27_Pc_0.0012587.dat}; \addlegendentry{$n_d$};
\addplot+ [purple, x filter/.expression={\thisrow{r}<1.7 ? x : nan}] table [x=r, y=ns] {../code/data/LSM3F_APR/star_sigma_800_B14_27_Pc_0.0012587.dat}; \addlegendentry{$n_s$};
%\addplot+ [blue, x filter/.expression={\thisrow{r}<1.7}] table [x=r, y=ne] {../code/data/LSM3F_APR/star_sigma_800_B14_27_Pc_0.0012587.dat}; \addlegendentry{$n_e$};
...
\addplot+ [black, solid, forget plot, x filter/.expression={\thisrow{r}>=1.7 ? x : nan}] table [x=r, y expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/3}] {../code/data/LSM3F_APR/star_sigma_800_B14_27_Pc_0.0012587.dat};
% cheat legend
...
\end{groupplot}
\node (title) at ($(group c1r1.north)!0.5!(group c2r1.north)$) [above, yshift=\pgfkeysvalueof{/pgfplots/every axis title shift}] {Maximum mass star profile ($m_\sigma=\SI{800}{\mega\electronvolt}$, $B^\frac14 = \SI{27}{\mega\electronvolt}$, $P_c=10^{34.730} \, \si{\pascal}$)};
\end{tikzpicture}
