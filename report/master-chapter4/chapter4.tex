...
\caption{\label{fig:hybrid:eos-all}%
	Six equations of state constructed like those in \cref{fig:hybrid:eos}
	with the parameters that generated the most massive quark stars
	in \cref{chap:lsm2f,chap:lsm3f}.
}
\end{figure}
...
In \cref{fig:hybrid:eos-all} we gather all six equations of state
for $N_f = \{2,3\}$ and $m_\sigma = \{600,700,800\} \, \si{\mega\electronvolt}$
and the corresponding lowest bag constants satisfying the lower bound \eqref{eq:lsm:bag_lower_bound}.
...
\item At first glance, the hybrid branches in the left panel seem to plummet in mass immediately after diverging from the mass-increasing hadronic curve,
      ...
      and such a segment is visible in all six branches, even if very tiny.
...
\item In fact, \cite[equation 15]{ref:hybrid_star_stability_criterion} shows that under general circumstances and no matter how small the quark core is,
      ...
      This criterion is therefore consistent with our hybrid branches.
