...
\caption{\label{fig:hybrid:eos-all}%
	Six hybrid equations of state constructed the one in \cref{fig:hybrid:eos}
...
We take a detailed look at the two maximum mass stars
on top of the longest stable hybrid branches in \cref{fig:hybrid:star},
\begin{itemize}
...
\item We see that the drop $\Delta \epsilon$ and $\Delta n_B$ in energy density and baryon density 
      is only about half as high in the two-flavor stars compared to the three-flavor stars.
\item The hadronic phase dominates, 
      ...
      and respectively $\SI{99.7}{\percent}$ and $\SI{99.0}{\percent}$ with three flavors.
\end{itemize}
...
Finally, we pay one last visit to our consistently fit two-flavor quark-meson model in \cref{sec:lsm2f:refinement}.
...
we repeat our calculations and find the results in \cref{fig:hybrid:consistent}
...
\TODO{create one super-figure with consistent fitting, including EOS, MR and radial profiles}
