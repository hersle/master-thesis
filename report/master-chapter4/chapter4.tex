...
To join the two equations of state for the hadronic phase $H$ and quark phase $Q$ into one hybrid version,
...
\addplot+ [blue!50!cyan, solid, very thick] table [x=muB1,y=P1] {../code/data/LSM2F_APR/eos_sigma_600.dat}; \addlegendentry{hadronic phase \quad};
...
\addplot+ [blue!50!cyan, solid, very thick] table [x=muB1,y=P1] {../code/data/LSM3F_APR/eos_sigma_600.dat}; \addlegendentry{hadronic phase \quad};
...
\addplot+ [red, solid, very thick] table [x=muB,y expr={\thisrow{nB2}/0.165}] {../code/data/LSM3F_APR/eos_sigma_600.dat}; \addlegendentry{quark phase \quad};
\addplot+ [blue!50!cyan, solid, very thick] table [x=muB1,y expr={\thisrow{nB1}/0.165}] {../code/data/LSM3F_APR/eos_sigma_600.dat}; \addlegendentry{hadronic phase \quad};
\addplot+ [black, dashed, very thick] table [x=muB,y expr={\thisrow{nB}/0.165}] {../code/data/LSM3F_APR/eos_sigma_600.dat}; \addlegendentry{hybrid phase \quad};
...
\addplot+ [red, solid, very thick] table [x=P,y=epsilon2] {../code/data/LSM3F_APR/eos_sigma_600.dat}; \addlegendentry{quark phase \quad};
\addplot+ [blue!50!cyan, solid, very thick] table [x=P1,y=epsilon1] {../code/data/LSM3F_APR/eos_sigma_600.dat}; \addlegendentry{hadronic phase \quad};
\addplot+ [black, dashed, very thick] table [x=P,y=epsilon] {../code/data/LSM3F_APR/eos_sigma_600.dat}; \addlegendentry{hybrid phase \quad};
...
A hybrid equation of state built with steps \ref{step:hybrid:one}--\ref{step:hybrid:four} in \cref{sec:hybrid:construction},
joining the three-flavor quark-meson model in \cref{chap:lsm3f}
with $m_\sigma=\SI{600}{\mega\electronvolt}$ and $B^\frac14 = \SI{111}{\mega\electronvolt}$
to the hadronic Akmal-Pandharipande-Ravenhall equation of state from \cite{ref:apr,ref:apr_data}.
}
\end{figure}
...
\addplot [red, very thick, solid] table [x=P, y=epsilon] {../code/data/LSM2F_APR/eos_sigma_600.dat};
\addlegendentry{$m_\sigma=\SI{600}{\mega\electronvolt}$, $\vphantom{\big)} \smash{B^\frac14} = \SI{111}{\mega\electronvolt}$};
\addplot [darkgreen, very thick, dashed] table [x=P, y=epsilon] {../code/data/LSM2F_APR/eos_sigma_700.dat};
\addlegendentry{$m_\sigma=\SI{700}{\mega\electronvolt}$, $\vphantom{\big)} \smash{B^\frac14} = \phantom{0}\SI{68}{\mega\electronvolt}$};
\addplot [blue, very thick, dotted] table [x=P, y=epsilon] {../code/data/LSM2F_APR/eos_sigma_800.dat};
...
\addplot [red, very thick, solid] table [x=P, y=epsilon] {../code/data/LSM3F_APR/eos_sigma_600.dat};
\addlegendentry{$m_\sigma=\SI{600}{\mega\electronvolt}$, $\vphantom{\big)} \smash{B^\frac14} = \SI{111}{\mega\electronvolt}$};
\addplot [darkgreen, very thick, dashed] table [x=P, y=epsilon] {../code/data/LSM3F_APR/eos_sigma_700.dat};
\addlegendentry{$m_\sigma=\SI{700}{\mega\electronvolt}$, $\vphantom{\big)} \smash{B^\frac14} = \phantom{0}\SI{68}{\mega\electronvolt}$};
\addplot [blue, very thick, dotted] table [x=P, y=epsilon] {../code/data/LSM3F_APR/eos_sigma_800.dat};
\addlegendentry{$m_\sigma=\SI{800}{\mega\electronvolt}$, $\vphantom{\big)} \smash{B^\frac14} = \phantom{0}\SI{27}{\mega\electronvolt}$};
\end{groupplot}
\end{tikzpicture}
...
\addplot+ [solid, very thick, gray] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_hadron.dat}; \addlegendentry{neutron stars};
\addplot+ [solid, very thick, mesh, mesh line legend] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F_APR/stars_sigma_600_B14_111.dat}; \addlegendentry{hybrid stars};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F_APR/stars_sigma_700_B14_68.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F_APR/stars_sigma_800_B14_27.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
...
\addplot+ [solid, very thick, gray] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_hadron.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F_APR/stars_sigma_600_B14_111.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F_APR/stars_sigma_700_B14_68.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F_APR/stars_sigma_800_B14_27.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\draw [Latex-] (11.4,2.09) -- (15.0,2.20) node [anchor=west] {$m_\sigma=\SI{800}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{27}{\mega\electronvolt}$};
\draw [Latex-] (11.5,2.00) -- (15.0,2.00) node [anchor=west] {$m_\sigma=\SI{700}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{68}{\mega\electronvolt}$};
...
\nextgroupplot[
	...
	xmin=5, xmax=35, ymin=0.5, ymax=2.5, xtick distance=5, ytick distance=0.5, minor tick num=4, grid=major,
	legend columns=5, legend pos=south east, legend cell align=right, legend transposed,
	colorbar horizontal, colormap name=plasmarev, colorbar style={width=11cm, ylabel=$\log_{10} (P_c \, / \, \si{\pascal})$, ylabel style={rotate=-90}, xtick distance=1, minor x tick num=9, at={(0.8,-0.2)}, anchor=north, xticklabel pos=lower},
];
\addplot [name path=J0748lo, draw=none, forget plot, domain=0:40] {2.08 - 0.07};
\addplot [name path=J0748hi, draw=none, forget plot, domain=0:40] {2.08 + 0.07};
\addplot [red, opacity=0.4] fill between [of=J0748lo and J0748hi]; \addlegendentry{PSR J0748$+$6620};
...
\addplot+ [solid, very thick, gray] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_hadron.dat}; \addlegendentry{neutron stars};
\addplot+ [solid, very thick, mesh, mesh line legend] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_sigma_600_B14_111.dat}; \addlegendentry{hybrid stars};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_sigma_700_B14_68.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_sigma_800_B14_27.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
...
\addplot+ [solid, very thick, gray] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_hadron.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_sigma_600_B14_111.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_sigma_700_B14_68.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_sigma_800_B14_27.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\draw [Latex-] (11.45,2.08) -- (15.0,2.20) node [anchor=west] {$m_\sigma=\SI{800}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{27}{\mega\electronvolt}$};
\draw [Latex-] (11.55,1.97) -- (15.0,2.00) node [anchor=west] {$m_\sigma=\SI{700}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{68}{\mega\electronvolt}$};
...
\addplot+ [index of colormap={1 of Set1-9}, very thick] table [x=r, y=epsilon] {../code/data/LSM2F_APR/star_sigma_600_B14_111_Pc_0.0011807.dat}; \addlegendentry{$\epsilon$};
\addplot+ [index of colormap={0 of Set1-9}, very thick] table [x=r, y=P] {../code/data/LSM2F_APR/star_sigma_600_B14_111_Pc_0.0011807.dat}; \addlegendentry{$P$};
\nextgroupplot[
	ylabel=$m \, / \, M_\odot$,
	xticklabels={,,},
	ymax=2.1, ytick distance=0.5, minor y tick num=4,
];
\addplot+ [black, very thick] table [x=r, y=m] {../code/data/LSM2F_APR/star_sigma_600_B14_111_Pc_0.0011807.dat};
\nextgroupplot[
	xlabel=$r \, / \, \si{\kilo\meter}$,
	ylabel=$\mu_B \, / \, \si{\giga\electronvolt}$,
	ymin=0.9, ymax=1.5, ytick distance=0.1, minor y tick num=4, % restrict y to domain=0.8:1.6,
];
\addplot+ [black, very thick] table [x=r, y expr={\thisrow{muQ}*3.0/1000.0}] {../code/data/LSM2F_APR/star_sigma_600_B14_111_Pc_0.0011807.dat};
\nextgroupplot[
	xlabel=$r \, / \, \si{\kilo\meter}$,
	ylabel=$n_i \, / \, n_\text{sat}$,
	ymax=15, ytick distance=5, minor y tick num=4,
];
\addplot+ [index of colormap={0 of Set1-9}, very thick, x filter/.expression={\thisrow{r}<3.14 ? x : nan}] table [x=r, y=nu] {../code/data/LSM2F_APR/star_sigma_600_B14_111_Pc_0.0011807.dat}; \addlegendentry{$n_u$};
\addplot+ [index of colormap={2 of Set1-9}, very thick, x filter/.expression={\thisrow{r}<3.14 ? x : nan}] table [x=r, y=nd] {../code/data/LSM2F_APR/star_sigma_600_B14_111_Pc_0.0011807.dat}; \addlegendentry{$n_d$};
...
\addplot+ [black, dashed, very thick, forget plot] table [x=r, y expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/3}] {../code/data/LSM2F_APR/star_sigma_600_B14_111_Pc_0.0011807.dat};
\addplot+ [black, solid, very thick, forget plot, x filter/.expression={\thisrow{r}>=3.14 ? x : nan}] table [x=r, y expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/3}] {../code/data/LSM2F_APR/star_sigma_600_B14_111_Pc_0.0011807.dat};
% cheat legend
\addplot+ [draw=none, black, solid, very thick] table [x=r, y expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/3}] {../code/data/LSM2F_APR/star_sigma_600_B14_111_Pc_0.0011807.dat}; \addlegendentry{$n_B$};
\end{groupplot}
...
\addplot+ [index of colormap={1 of Set1-9}, very thick] table [x=r, y=epsilon] {../code/data/LSM3F_APR/star_sigma_600_B14_111_Pc_0.0008161.dat}; \addlegendentry{$\epsilon$};
\addplot+ [index of colormap={0 of Set1-9}, very thick] table [x=r, y=P] {../code/data/LSM3F_APR/star_sigma_600_B14_111_Pc_0.0008161.dat}; \addlegendentry{$P$};
\nextgroupplot[
	ylabel=$m \, / \, M_\odot$,
	xticklabels={,,},
	ymax=2.1, ytick distance=0.5, minor y tick num=4,
];
\addplot+ [black, very thick] table [x=r, y=m] {../code/data/LSM3F_APR/star_sigma_600_B14_111_Pc_0.0008161.dat};
\nextgroupplot[
	xlabel=$r \, / \, \si{\kilo\meter}$,
	ylabel=$\mu_B \, / \, \si{\giga\electronvolt}$,
	ymin=0.9, ymax=1.5, ytick distance=0.1, minor y tick num=4, % restrict y to domain=0.8:1.6,
];
\addplot+ [black, very thick] table [x=r, y expr={\thisrow{muQ}*3.0/1000.0}] {../code/data/LSM3F_APR/star_sigma_600_B14_111_Pc_0.0008161.dat};
\nextgroupplot[
	xlabel=$r \, / \, \si{\kilo\meter}$,
	ylabel=$n_i \, / \, n_\text{sat}$,
	ymax=15, ytick distance=5, minor y tick num=4,
];
\addplot+ [index of colormap={0 of Set1-9}, very thick, x filter/.expression={\thisrow{r}<1.64 ? x : nan}] table [x=r, y=nu] {../code/data/LSM3F_APR/star_sigma_600_B14_111_Pc_0.0008161.dat}; \addlegendentry{$n_u$};
\addplot+ [index of colormap={2 of Set1-9}, very thick, x filter/.expression={\thisrow{r}<1.64 ? x : nan}] table [x=r, y=nd] {../code/data/LSM3F_APR/star_sigma_600_B14_111_Pc_0.0008161.dat}; \addlegendentry{$n_d$};
\addplot+ [index of colormap={6 of Set1-9}, very thick, x filter/.expression={\thisrow{r}<1.64 ? x : nan}] table [x=r, y=ns] {../code/data/LSM3F_APR/star_sigma_600_B14_111_Pc_0.0008161.dat}; \addlegendentry{$n_s$};
...
\addplot+ [black, dashed, very thick, forget plot] table [x=r, y expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/3}] {../code/data/LSM3F_APR/star_sigma_600_B14_111_Pc_0.0008161.dat};
\addplot+ [black, solid, very thick, forget plot, x filter/.expression={\thisrow{r}>=1.64 ? x : nan}] table [x=r, y expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/3}] {../code/data/LSM3F_APR/star_sigma_600_B14_111_Pc_0.0008161.dat};
% cheat legend
\addplot+ [draw=none, black, very thick, solid] table [x=r, y expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/3}] {../code/data/LSM3F_APR/star_sigma_600_B14_111_Pc_0.0008161.dat}; \addlegendentry{$n_B$};
\end{groupplot}
...
\addplot [red, very thick, solid] table [x=P, y=epsilon] {../code/data/LSM2FC_APR/eos_sigma_400.dat};
\addlegendentry{$m_\sigma=\SI{400}{\mega\electronvolt}$, $\vphantom{\big)}\smash{B^\frac14} = \SI{107}{\mega\electronvolt}$};
\addplot [darkgreen, very thick, dashed] table [x=P, y=epsilon] {../code/data/LSM2FC_APR/eos_sigma_500.dat};
\addlegendentry{$m_\sigma=\SI{500}{\mega\electronvolt}$, $\vphantom{\big)}\smash{B^\frac14} = \phantom{0}\SI{84}{\mega\electronvolt}$};
\addplot [blue, very thick, dotted] table [x=P, y=epsilon] {../code/data/LSM2FC_APR/eos_sigma_600.dat};
...
\caption{\label{fig:hybrid:eos-consistent}%
	...
	but with the consistently fit two-flavor quark-meson model from \cref{sec:lsm2f:refinement}.
}
\end{figure}
...
\addplot+ [solid, very thick, gray] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_hadron.dat}; \addlegendentry{neutron stars};
\addplot+ [solid, very thick, mesh, mesh line legend] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC_APR/stars_sigma_400_B14_107.dat}; \addlegendentry{hybrid stars};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC_APR/stars_sigma_500_B14_84.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC_APR/stars_sigma_600_B14_27.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\draw [Latex-] (11.4,2.09) -- (15.0,2.20) node [anchor=west] {$m_\sigma=\SI{600}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{27}{\mega\electronvolt}$};
\draw [Latex-] (11.5,2.00) -- (15.0,2.00) node [anchor=west] {$m_\sigma=\SI{500}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{84}{\mega\electronvolt}$};
\draw [Latex-] (11.5,1.98) -- (15.0,1.80) node [anchor=west] {$m_\sigma=\SI{400}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{107}{\mega\electronvolt}$};
...
\addplot+ [solid, very thick, gray] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F_APR/stars_hadron.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC_APR/stars_sigma_400_B14_107.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC_APR/stars_sigma_500_B14_84.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC_APR/stars_sigma_600_B14_27.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\draw [Latex-] (11.4,2.09) -- (15.0,2.20) node [anchor=west] {$m_\sigma=\SI{600}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{27}{\mega\electronvolt}$};
\draw [Latex-] (11.5,2.00) -- (15.0,2.00) node [anchor=west] {$m_\sigma=\SI{500}{\mega\electronvolt}$, $\smash{B^\frac14} = \SI{84}{\mega\electronvolt}$};
...
\caption{\label{fig:hybrid:mass-radius-consistent}%
	...
	but with the consistently fit two-flavor hybrid equations of state from \cref{fig:hybrid:eos-consistent}.
}
\end{figure}
...
\addplot+ [index of colormap={1 of Set1-9}, very thick] table [x=r, y=epsilon] {../code/data/LSM2FC_APR/star_sigma_400_B14_107_Pc_0.0011807.dat}; \addlegendentry{$\epsilon$};
\addplot+ [index of colormap={0 of Set1-9}, very thick] table [x=r, y=P] {../code/data/LSM2FC_APR/star_sigma_400_B14_107_Pc_0.0011807.dat}; \addlegendentry{$P$};
\nextgroupplot[
	ylabel=$m \, / \, M_\odot$,
	xticklabels={,,},
	ymax=2.1, ytick distance=0.5, minor y tick num=4,
];
\addplot+ [black, very thick] table [x=r, y=m] {../code/data/LSM2FC_APR/star_sigma_400_B14_107_Pc_0.0011807.dat};
\nextgroupplot[
	xlabel=$r \, / \, \si{\kilo\meter}$,
	ylabel=$\mu_B \, / \, \si{\giga\electronvolt}$,
	ymin=0.9, ymax=1.5, ytick distance=0.1, minor y tick num=4, % restrict y to domain=0.8:1.6,
];
\addplot+ [black, very thick] table [x=r, y expr={\thisrow{muQ}*3.0/1000.0}] {../code/data/LSM2FC_APR/star_sigma_400_B14_107_Pc_0.0011807.dat};
\nextgroupplot[
	xlabel=$r \, / \, \si{\kilo\meter}$,
	ylabel=$n_i \, / \, n_\text{sat}$,
	ymax=15, ytick distance=5, minor y tick num=4,
];
\addplot+ [index of colormap={0 of Set1-9}, very thick, x filter/.expression={\thisrow{r}<3.22 ? x : nan}] table [x=r, y=nu] {../code/data/LSM2FC_APR/star_sigma_400_B14_107_Pc_0.0011807.dat}; \addlegendentry{$n_u$};
\addplot+ [index of colormap={2 of Set1-9}, very thick, x filter/.expression={\thisrow{r}<3.22 ? x : nan}] table [x=r, y=nd] {../code/data/LSM2FC_APR/star_sigma_400_B14_107_Pc_0.0011807.dat}; \addlegendentry{$n_d$};
...
\addplot+ [black, dashed, very thick, forget plot] table [x=r, y expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/3}] {../code/data/LSM2FC_APR/star_sigma_400_B14_107_Pc_0.0011807.dat};
\addplot+ [black, solid, very thick, forget plot, x filter/.expression={\thisrow{r}>=3.22 ? x : nan}] table [x=r, y expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/3}] {../code/data/LSM2FC_APR/star_sigma_400_B14_107_Pc_0.0011807.dat};
% cheat legend
\addplot+ [draw=none, black, very thick, solid] table [x=r, y expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/3}] {../code/data/LSM2FC_APR/star_sigma_400_B14_107_Pc_0.0011807.dat}; \addlegendentry{$n_B$};
\end{groupplot}
...
In this chapter we have constructed hybrid stars modeled with the two-flavor and three-flavor quark-meson models in the core,
