...
\addplot [mark=none, mesh, semithick] table [x expr={10*\thisrow{R}}, y=M, meta expr={sign(\thisrow{omega2})}] {../code/data/gr2.dat};

\nextgroupplot[
	title={\subcaption{\label{fig:nstars:stability_exact}Exact stability}},
	xlabel=$R / \si{\kilo\meter}$,
]
\addplot [mark=none, mesh, semithick] table [x expr={10*\thisrow{R}}, y=M, meta expr={sign(\thisrow{P}-\maxPgr)}] {../code/data/gr2.dat};
\end{groupplot}
\end{tikzpicture}
