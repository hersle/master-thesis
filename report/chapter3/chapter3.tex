...
\addplot [mark=none, mesh, very thick] table [x expr={10*\thisrow{R}}, y=M, meta expr={log10(\thisrow{P} * 4.266500881855305e+34)}] {../code/data/nr.dat} node [pos=0.67, pin={[text=black]0:Non-relativistic limit $p_F \ll mc$}] {};
\addplot [mark=none, mesh, very thick] table [x expr={10*\thisrow{R}}, y=M, meta expr={log10(\thisrow{P} * 4.266500881855305e+34)}] {../code/data/gr.dat} node [pos=0.61, pin={[text=black]-100:Arbitrary $p_F$}] {};
