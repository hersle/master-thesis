...
The boundary conditions are \TODO{cite ref catalogue}
\begin{equation}
...
\end{equation}
From their definitions \TODO{ref} and criterion \eqref{eq:nstars:stability_pressure_energy_density}, $\gamma$, and hence $\Pi$ and $W$, are positive for all $r$.
