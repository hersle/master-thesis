...
\newbibmacro*{university+date}{%
	\printtext{Written in}%
	\setunit*{\addspace}%
	\mkbibbold{\printdate}%\printfield{year}%
	\setunit*{\addspace}%
	\printtext{at}%
...
\title{%
	The Fundamentals of Ideal Neutron Stars \\ \ \\
	\normalsize Tolman-Oppenheimer-Volkoff equations, equation of state and stability analysis
}
