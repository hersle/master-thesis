...
Together, they show that neutron stars are stable up to the maximum central pressure $P_0 \approx \SI{1e35}{\pascal} $ with a corresponding maximum mass $M = 0.71 \solarmass$ and minimum radius $R = \SI{9.1}{\kilo\meter}$, but become unstable for greater central pressures.
...
Nevertheless, it is both surprising and impressive that a naive model of a neutron star as a simple sphere of non-interactings neutrons give estimates that are certainly of the right order of magnitude.
