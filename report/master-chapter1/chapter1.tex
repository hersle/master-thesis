...
Can we somehow modify the deconfined model to incorporate confinement?
...
\end{equation}
effectively moving the equation of state in \cref{fig:mit:eos-eos} $45^\circ$ north-west.
The vacuum constant is hence a phenomenological parameter that we can vary
to adjust the normalization of the grand potential in vacuum,
and hence the zero-point energy and pressure and equation of state.
