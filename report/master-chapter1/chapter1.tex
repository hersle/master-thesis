...
\end{equation}
The program in \TODO{ref appendix} solves these inequalities numerically:
...
For the two-flavor and three-flavor equations of state in \cref{fig:mit:eos},
it reports the bounds
\begin{equation}
	\SI{144.3}{\mega\electronvolt} < B^\frac14 < \SI{154.9}{\mega\electronvolt} .
\end{equation}
The lower bound comes from the two-flavor case, and the upper bound from the three-flavor case.

\TODO{get very different $B$ in LSM. but this is because meson potential contributes to effective bag pressure before the crossover?}
