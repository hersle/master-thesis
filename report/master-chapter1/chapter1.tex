...
As mentioned in \cref{sec:master_intro:tov},
...
The MIT bag model realizes quark stars with maximum masses $1.6 \, M_\odot < M < 2.0 \, M_\odot$ and radii $\SI{9}{\kilo\meter} < R < \SI{11}{\kilo\meter}$.
