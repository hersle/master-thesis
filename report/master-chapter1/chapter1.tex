...
\TODO{inspiration from Kyllingstad figure 1.5?}
...
\TODO{why zero pressure??? JO nor I understand properly. found somewhere saying $P=0$ corresponds to stability of the system, therefore comparison is done at $P=0$.}
\begin{equation}
...
\TODO{add bag constant labels. make lines more different (opacity diff is not very apparent on paper)}
}
\end{figure}
