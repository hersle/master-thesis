...
It also exposes the Dirac sea vacuum divergence in the pole $N_c N_f m_q^4 / 16 \pi^2 \epsilon$.
...
Note that the fermionic contribution to the grand potential \eqref{eq:lsm:grand_potential} is of order $\bigo(N_c^1)$,
while any bosonic contribution would necessarily only be of order $\bigo(N_c^0)$.
Although our exclusion of bosonic fluctuations 
and inclusion of fermionic fluctuations
is \emph{inconsistent} with respect to the number of loops considered in Feynman diagrams,
this approach can be regarded as \emph{consistent} in the large-$N_c$ approximation scheme.
