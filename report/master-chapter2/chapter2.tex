...
{Maximum mass star profile ($m_\sigma=\SI{800}{\mega\electronvolt}$, $B^\frac14 = \SI{27}{\mega\electronvolt}$, $P_c=10^{34.727} \, \si{\pascal}$)};
\end{tikzpicture}
...
we obtained stars with maximum  masses $1.7 \, M_\odot < M < 2.0 \, M_\odot$ and corresponding radii $R \approx \SI{11}{\kilo\meter}$ for different choices of $m_\sigma$.
