...
\label{eq:lsm:grand_potential_minimize}
\end{equation}
...
\TODO{comment on inconsistent (?) matching. write $m_\sigma=\{700,800\}$ in table. include $\Lambda$}
...
\caption{\label{fig:lsm:grand-potential-noisospin}%
	The grand potential \eqref{eq:lsm:grand_potential} with $\mu_e = 0$ and $\mu_u = \mu_d = \mu$ for $m_\sigma=\{700,800\} \, \si{\mega\electronvolt}$.
	The \textcolor{blue}{blue line} and its \textcolor{gray}{gray projection} corresponds to minima determined by $\pdv{\Omega}/{\avg{\sigma}} = 0$.
}
\end{figure}
