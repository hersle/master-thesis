...
\pgfplotsset{cycle list shift=+3} % skip weakest line
\addplot+ [very thick] table [x=Deltax, y=Omega] {../code/data/LSM2F/potential_vacuum_sigma500.dat}; \addlegendentry{$m_\sigma = \SI{500}{\mega\electronvolt}$};
...
\addplot+ [very thick] table [x=Deltax, y=Omega] {../code/data/LSM2F/potential_vacuum_sigma600.dat}; \addlegendentry{$m_\sigma = \SI{600}{\mega\electronvolt}$};
...
\addplot+ [very thick] table [x=Deltax, y=Omega] {../code/data/LSM2F/potential_vacuum_sigma700.dat}; \addlegendentry{$m_\sigma = \SI{700}{\mega\electronvolt}$};
...
\addplot+ [very thick] table [x=Deltax, y=Omega] {../code/data/LSM2F/potential_vacuum_sigma800.dat}; \addlegendentry{$m_\sigma = \SI{800}{\mega\electronvolt}$};
...
\addplot                                                                            coordinates {(300,-2.38)} node [above, yshift=+0.1cm, font=\footnotesize, black] {no minimum!}; % 500
\addplot [every axis plot post/.append style={only marks, mark=*}, mark size=1.0pt] coordinates {(300,-3.97)} node [above, yshift=+0.1cm, font=\footnotesize] {minimum}; % 600
\addplot [every axis plot post/.append style={only marks, mark=*}, mark size=1.0pt] coordinates {(300,-5.85)} node [above, yshift=+0.1cm, font=\footnotesize] {minimum}; % 700
\addplot [every axis plot post/.append style={only marks, mark=*}, mark size=1.0pt] coordinates {(300,-8.02)} node [above, yshift=+0.1cm, font=\footnotesize] {minimum}; % 800

\end{axis}
\end{tikzpicture}
\caption{\label{fig:lsm:potential_sigma_mass}
The two-flavor grand potential \eqref{eq:lsm:grand_potential}
admits minima for the quark mass $m_q = g \avg{\sigma}$ in vacuum, where $\vec{\mu}=\vec{0}$,
only when fit to $m_\sigma \geq \SI{600}{\mega\electronvolt}$ at tree-level.
}
\end{figure}
...
\nextgroupplot[
	...
	zlabel = {$\Omega \, / \, (\SI{100}{\mega\electronvolt})^4$},
	zlabel style={yshift=-9pt}, zticklabel style={xshift=+3pt},
...
\addplot3 [blue, very thick, x filter/.expression={\thisrow{Delta0} < 150 ? x : nan}] table [x=Delta0, y=mu0, z=Omega0]     {../code/data/LSM2F/potential_noisospin_sigma_700.dat}; % plot line of minima
\addplot3 [blue, very thick, x filter/.expression={\thisrow{Delta0} > 150 ? x : nan}] table [x=Delta0, y=mu0, z=Omega0]     {../code/data/LSM2F/potential_noisospin_sigma_700.dat}; % plot line of minima
\addplot3 [gray, very thick, x filter/.expression={\thisrow{Delta0} < 150 ? x : nan}] table [x=Delta0, y=mu0, z expr={-40}] {../code/data/LSM2F/potential_noisospin_sigma_700.dat}; % plot its "shadow" in bottom plane
\addplot3 [gray, very thick, x filter/.expression={\thisrow{Delta0} > 150 ? x : nan}] table [x=Delta0, y=mu0, z expr={-40}] {../code/data/LSM2F/potential_noisospin_sigma_700.dat}; % plot its "shadow" in bottom plane
\nextgroupplot[
	yticklabels={,,},
	zticklabels={,,},
...
\addplot3 [blue, very thick] table [x=Delta0, y=mu0, z=Omega0]     {../code/data/LSM2F/potential_noisospin_sigma_800.dat}; % plot line of minima
\addplot3 [gray, very thick] table [x=Delta0, y=mu0, z expr={-40}] {../code/data/LSM2F/potential_noisospin_sigma_800.dat}; % plot its "shadow" in bottom plane
\end{groupplot}
\end{tikzpicture}
\caption{\label{fig:lsm:grand-potential-noisospin}%
	...
	For \subref{fig:lsm:grand-potential-noisospin-sigma700} $m_\sigma <    \SI{800}{\mega\electronvolt}$ it jumps in a \emph{discontinuous phase transition}, while
	for \subref{fig:lsm:grand-potential-noisospin-sigma800} $m_\sigma \geq \SI{800}{\mega\electronvolt}$ it moves quickly and continuously in a \emph{crossover} and there is no phase transition.
}
\end{figure}
...
\addplot+ [black, very thick, densely dotted] {-100}; \addlegendentry{$m_\sigma=\SI{600}{\mega\electronvolt}$};
\addplot+ [black, very thick, densely dashed] {-100}; \addlegendentry{$m_\sigma=\SI{700}{\mega\electronvolt}$};
\addplot+ [black, very thick, solid] {-100}; \addlegendentry{$m_\sigma=\SI{800}{\mega\electronvolt}$};
\addplot+ [index of colormap={1 of Set1-9}, very thick, densely dotted, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mue]    {../code/data/LSM2F/eos_sigma_600.dat};
\addplot+ [index of colormap={1 of Set1-9}, very thick, densely dashed, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mue]    {../code/data/LSM2F/eos_sigma_700.dat};
\addplot+ [index of colormap={1 of Set1-9}, very thick, solid, opacity=1.0] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mue]    {../code/data/LSM2F/eos_sigma_800.dat}; \addlegendentry{$\mu_e$};
\addplot+ [index of colormap={2 of Set1-9}, very thick, densely dotted, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mud]    {../code/data/LSM2F/eos_sigma_600.dat};
\addplot+ [index of colormap={2 of Set1-9}, very thick, densely dashed, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mud]    {../code/data/LSM2F/eos_sigma_700.dat};
\addplot+ [index of colormap={2 of Set1-9}, very thick, solid, opacity=1.0] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mud]    {../code/data/LSM2F/eos_sigma_800.dat}; \addlegendentry{$\mu_d$};
\addplot+ [index of colormap={0 of Set1-9}, very thick, densely dotted, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=muu]    {../code/data/LSM2F/eos_sigma_600.dat};
\addplot+ [index of colormap={0 of Set1-9}, very thick, densely dashed, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=muu]    {../code/data/LSM2F/eos_sigma_700.dat};
\addplot+ [index of colormap={0 of Set1-9}, very thick, solid, opacity=1.0] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=muu]    {../code/data/LSM2F/eos_sigma_800.dat}; \addlegendentry{$\mu_u$};
\addplot+ [index of colormap={4 of Set1-9}, very thick, densely dotted, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mu] {../code/data/LSM2F/eos_sigma_600.dat};
\addplot+ [index of colormap={4 of Set1-9}, very thick, densely dashed, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mu] {../code/data/LSM2F/eos_sigma_700.dat};
\addplot+ [index of colormap={4 of Set1-9}, very thick, solid, opacity=1.0] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mu] {../code/data/LSM2F/eos_sigma_800.dat}; \addlegendentry{$m_q$};
...
\addplot+ [black, very thick, densely dotted] {-10}; \addlegendentry{$m_\sigma=\SI{600}{\mega\electronvolt}$};
\addplot+ [black, very thick, densely dashed] {-10}; \addlegendentry{$m_\sigma=\SI{700}{\mega\electronvolt}$};
\addplot+ [black, very thick, solid] {-10}; \addlegendentry{$m_\sigma=\SI{800}{\mega\electronvolt}$};
...
\addplot+ [index of colormap={1 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ne] {../code/data/LSM2F/eos_sigma_600.dat};
\addplot+ [index of colormap={1 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ne] {../code/data/LSM2F/eos_sigma_700.dat};
\addplot+ [index of colormap={1 of Set1-9}, solid, very thick, opacity=1.0] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ne] {../code/data/LSM2F/eos_sigma_800.dat}; \addlegendentry{$n_e\,\,$};
\addplot+ [index of colormap={2 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nd] {../code/data/LSM2F/eos_sigma_600.dat};
\addplot+ [index of colormap={2 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nd] {../code/data/LSM2F/eos_sigma_700.dat};
\addplot+ [index of colormap={2 of Set1-9}, solid, very thick, opacity=1.0] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nd] {../code/data/LSM2F/eos_sigma_800.dat}; \addlegendentry{$n_d\,\,$};
\addplot+ [index of colormap={0 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nu] {../code/data/LSM2F/eos_sigma_600.dat};
\addplot+ [index of colormap={0 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nu] {../code/data/LSM2F/eos_sigma_700.dat};
\addplot+ [index of colormap={0 of Set1-9}, solid, very thick, opacity=1.0] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nu] {../code/data/LSM2F/eos_sigma_800.dat}; \addlegendentry{$n_u\,\,$};
...
\addplot+ [black, solid, very thick, opacity=1.0] table [x=Porg,y=epsilonorg] {../code/data/LSM2F/eos_sigma_800.dat}; \addlegendentry{$m_\sigma=\SI{800}{\mega\electronvolt}$}
%\addplot+ [black, solid, opacity=1.0, forget plot] table [x=P,y=epsilon] {../code/data/LSM2F/eos_sigma_800.dat};
\addplot+ [gray, densely dashed, very thick, opacity=1.0, forget plot] table [x=Porg,y=epsilonorg] {../code/data/LSM2F/eos_sigma_700.dat};
\addplot+ [black, densely dashed, very thick, opacity=1.0] table [x=P,y=epsilon] {../code/data/LSM2F/eos_sigma_700.dat}; \addlegendentry{$m_\sigma=\SI{700}{\mega\electronvolt}$}
\addplot+ [gray, densely dotted, very thick, opacity=1.0, forget plot] table [x=Porg,y=epsilonorg] {../code/data/LSM2F/eos_sigma_600.dat};
\addplot+ [black, densely dotted, very thick, opacity=1.0] table [x=P,y=epsilon] {../code/data/LSM2F/eos_sigma_600.dat}; \addlegendentry{$m_\sigma=\SI{600}{\mega\electronvolt}$}
\addplot+ [black, solid, very thick, opacity=0.2, domain=0:0.1] {3*x}; \addlegendentry{$m_{\phantom{\sigma}} = 0$};
\addplot+ [gray, solid, very thick, domain=0:0.01] {-0.01}; \addlegendentry{uncorrected}
\addplot+ [black, solid, very thick, domain=0:0.01] {-0.01}; \addlegendentry{\phantom{un}corrected}
...
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_600_B14_111.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_600_B14_131.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_600_B14_151.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
...
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_700_B14_68.dat};  % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_700_B14_88.dat};  % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_700_B14_108.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
...
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_800_B14_27.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_800_B14_47.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_800_B14_67.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
...
\addplot+ [index of colormap={1 of Set1-9}, very thick] table [x=r, y=epsilon] {../code/data/LSM2F/star_sigma_800_B14_27_Pc_0.0012501.dat}; \addlegendentry{$\epsilon$};
\addplot+ [index of colormap={0 of Set1-9}, very thick] table [x=r, y=P] {../code/data/LSM2F/star_sigma_800_B14_27_Pc_0.0012501.dat}; \addlegendentry{$P$};
\nextgroupplot[
	ylabel=$m \, / \, M_\odot$,
	xticklabels={,,},
	ymax=2, ytick distance=0.5, minor y tick num=4,
];
\addplot+ [black, very thick] table [x=r, y=m] {../code/data/LSM2F/star_sigma_800_B14_27_Pc_0.0012501.dat};
\nextgroupplot[
	xlabel=$r \, / \, \si{\kilo\meter}$,
	ylabel=$\mu \, / \, \si{\mega\electronvolt}$,
	ymin=300, ymax=500, ytick distance=50, minor y tick num=4,
];
\addplot+ [black, very thick] table [x=r, y=muQ] {../code/data/LSM2F/star_sigma_800_B14_27_Pc_0.0012501.dat};
\nextgroupplot[
	xlabel=$r \, / \, \si{\kilo\meter}$,
	ylabel=$n_i \, / \, n_\text{sat}$,
	ymax=15, ytick distance=5, minor y tick num=4,
];
\addplot+ [index of colormap={0 of Set1-9}, very thick] table [x=r, y=nu] {../code/data/LSM2F/star_sigma_800_B14_27_Pc_0.0012501.dat}; \addlegendentry{$n_u$};
\addplot+ [index of colormap={2 of Set1-9}, very thick] table [x=r, y=nd] {../code/data/LSM2F/star_sigma_800_B14_27_Pc_0.0012501.dat}; \addlegendentry{$n_d$};
\addplot+ [index of colormap={1 of Set1-9}, very thick] table [x=r, y=ne] {../code/data/LSM2F/star_sigma_800_B14_27_Pc_0.0012501.dat}; \addlegendentry{$n_e$};
\addplot+ [black, dashed, forget plot, very thick] table [x=r, y expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/3}] {../code/data/LSM2F/star_sigma_800_B14_27_Pc_0.0012501.dat};
% cheat legend
\addplot+ [draw=none, black, solid, very thick] table [x=r, y expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/3}] {../code/data/LSM2F/star_sigma_800_B14_27_Pc_0.0012501.dat}; \addlegendentry{$n_B$};
\end{groupplot}
...
\pgfplotsset{cycle list/YlOrRd-7}
\begin{tikzpicture}
\begin{axis}[
	width = 15cm, height = 7cm,
	xmin=-500, xmax=+500, xtick distance = 100, minor x tick num=9,
...
\pgfplotsset{cycle list shift=+6} % skip weakest line
\addplot+ [very thick, black, dashed] {-12}; \addlegendentry{``Consistent''};
\addplot+ [very thick, black, solid]  {-12}; \addlegendentry{``Inconsistent''};
\addplot+ [very thick] table [x=Deltax, y=Omega] {../code/data/LSM2FC/potential_vacuum_sigma400.dat}; \addlegendentry{$m_\sigma = \SI{400}{\mega\electronvolt}$};
\addplot+ [very thick] table [x=Deltax, y=Omega] {../code/data/LSM2F/potential_vacuum_sigma600.dat};  \addlegendentry{$m_\sigma = \SI{600}{\mega\electronvolt}$};
\addplot+ [very thick] table [x=Deltax, y=Omega] {../code/data/LSM2FC/potential_vacuum_sigma500.dat}; \addlegendentry{$m_\sigma = \SI{500}{\mega\electronvolt}$};
\addplot+ [very thick] table [x=Deltax, y=Omega] {../code/data/LSM2F/potential_vacuum_sigma700.dat};  \addlegendentry{$m_\sigma = \SI{700}{\mega\electronvolt}$};
\addplot+ [very thick] table [x=Deltax, y=Omega] {../code/data/LSM2FC/potential_vacuum_sigma600.dat}; \addlegendentry{$m_\sigma = \SI{600}{\mega\electronvolt}$};
\addplot+ [very thick] table [x=Deltax, y=Omega] {../code/data/LSM2F/potential_vacuum_sigma800.dat};  \addlegendentry{$m_\sigma = \SI{800}{\mega\electronvolt}$};
...
\addplot+ [black, densely dotted, very thick] {-100}; \addlegendentry{$m_\sigma=\SI{400}{\mega\electronvolt}$};
\addplot+ [black, densely dashed, very thick] {-100}; \addlegendentry{$m_\sigma=\SI{500}{\mega\electronvolt}$};
\addplot+ [black, solid, very thick] {-100}; \addlegendentry{$m_\sigma=\SI{600}{\mega\electronvolt}$};
\addplot+ [index of colormap={1 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mue]    {../code/data/LSM2FC/eos_sigma_400.dat};
\addplot+ [index of colormap={1 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mue]    {../code/data/LSM2FC/eos_sigma_500.dat};
\addplot+ [index of colormap={1 of Set1-9}, solid, very thick, opacity=1.0] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mue]    {../code/data/LSM2FC/eos_sigma_600.dat}; \addlegendentry{$\mu_e$};
\addplot+ [index of colormap={2 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mud]    {../code/data/LSM2FC/eos_sigma_400.dat};
\addplot+ [index of colormap={2 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mud]    {../code/data/LSM2FC/eos_sigma_500.dat};
\addplot+ [index of colormap={2 of Set1-9}, solid, very thick, opacity=1.0] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mud]    {../code/data/LSM2FC/eos_sigma_600.dat}; \addlegendentry{$\mu_d$};
\addplot+ [index of colormap={0 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=muu]    {../code/data/LSM2FC/eos_sigma_400.dat};
\addplot+ [index of colormap={0 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=muu]    {../code/data/LSM2FC/eos_sigma_500.dat};
\addplot+ [index of colormap={0 of Set1-9}, solid, very thick, opacity=1.0] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=muu]    {../code/data/LSM2FC/eos_sigma_600.dat}; \addlegendentry{$\mu_u$};
\addplot+ [index of colormap={4 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mu] {../code/data/LSM2FC/eos_sigma_400.dat};
\addplot+ [index of colormap={4 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mu] {../code/data/LSM2FC/eos_sigma_500.dat};
\addplot+ [index of colormap={4 of Set1-9}, solid, very thick, opacity=1.0] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mu] {../code/data/LSM2FC/eos_sigma_600.dat}; \addlegendentry{$m_q$};
\addplot+ [black, every axis plot post/.append style={mark=*, mark options={fill=black}}, solid, domain=0:1, samples=2, forget plot] ({138/(1.12-0.88)}, {0.88*138/(1.12-0.88)+138*x}) node [pos=0.5, right] {$m_\pi$};
...
\addplot+ [black, densely dotted, very thick] {-10}; \addlegendentry{$m_\sigma=\SI{400}{\mega\electronvolt}$};
\addplot+ [black, densely dashed, very thick] {-10}; \addlegendentry{$m_\sigma=\SI{500}{\mega\electronvolt}$};
\addplot+ [black, solid, very thick] {-10}; \addlegendentry{$m_\sigma=\SI{600}{\mega\electronvolt}$};
\addplot+ [index of colormap={0 of Set1-9}, solid, very thick, opacity=0.2, forget plot, domain=0:700] {nq(muu(x))*nconv};
\addplot+ [index of colormap={2 of Set1-9}, solid, very thick, opacity=0.2, forget plot, domain=0:700] {nq(mud(x))*nconv};
\addplot+ [index of colormap={1 of Set1-9}, solid, very thick, opacity=0.2, forget plot, domain=0:700] {ne(mue(x))*nconv};
\addlegendimage{empty legend} \addlegendentry{}
\addplot+ [index of colormap={1 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ne] {../code/data/LSM2FC/eos_sigma_400.dat};
\addplot+ [index of colormap={1 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ne] {../code/data/LSM2FC/eos_sigma_500.dat};
\addplot+ [index of colormap={1 of Set1-9}, solid, very thick, opacity=1.0] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ne] {../code/data/LSM2FC/eos_sigma_600.dat}; \addlegendentry{$n_e\,\,$};
\addplot+ [index of colormap={2 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nd] {../code/data/LSM2FC/eos_sigma_400.dat};
\addplot+ [index of colormap={2 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nd] {../code/data/LSM2FC/eos_sigma_500.dat};
\addplot+ [index of colormap={2 of Set1-9}, solid, very thick, opacity=1.0] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nd] {../code/data/LSM2FC/eos_sigma_600.dat}; \addlegendentry{$n_d\,\,$};
\addplot+ [index of colormap={0 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nu] {../code/data/LSM2FC/eos_sigma_400.dat};
\addplot+ [index of colormap={0 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nu] {../code/data/LSM2FC/eos_sigma_500.dat};
\addplot+ [index of colormap={0 of Set1-9}, solid, very thick, opacity=1.0] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nu] {../code/data/LSM2FC/eos_sigma_600.dat}; \addlegendentry{$n_u\,\,$};
...
\addplot+ [black, solid, very thick, opacity=1.0] table [x=Porg,y=epsilonorg] {../code/data/LSM2FC/eos_sigma_600.dat}; \addlegendentry{$m_\sigma=\SI{600}{\mega\electronvolt}$};
\addplot+ [gray, densely dashed, very thick, opacity=1.0, forget plot] table [x=Porg,y=epsilonorg] {../code/data/LSM2FC/eos_sigma_500.dat};
\addplot+ [black, densely dashed, very thick, opacity=1.0] table [x=P,y=epsilon] {../code/data/LSM2FC/eos_sigma_500.dat}; \addlegendentry{$m_\sigma=\SI{500}{\mega\electronvolt}$};
\addplot+ [gray, densely dotted, very thick, opacity=1.0, forget plot] table [x=Porg,y=epsilonorg] {../code/data/LSM2FC/eos_sigma_400.dat};
\addplot+ [black, densely dotted, very thick, opacity=1.0] table [x=P,y=epsilon] {../code/data/LSM2FC/eos_sigma_400.dat}; \addlegendentry{$m_\sigma=\SI{400}{\mega\electronvolt}$};
\addplot+ [black, solid, very thick, opacity=0.2, domain=0:0.1] {3*x}; \addlegendentry{$m_{\phantom{\sigma}}=0$};
...
Results like those in \cref{fig:lsm:2-flavor-eos}, but with the consistently fit one-loop and large-$N_c$ grand potential \eqref{eq:lsm2f:grand_potential_consistent}
...
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC/stars_sigma_400_B14_107.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC/stars_sigma_400_B14_127.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC/stars_sigma_400_B14_147.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
...
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC/stars_sigma_500_B14_84.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC/stars_sigma_500_B14_104.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC/stars_sigma_500_B14_124.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
...
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC/stars_sigma_600_B14_27.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC/stars_sigma_600_B14_47.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, very thick, mesh] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2FC/stars_sigma_600_B14_67.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
