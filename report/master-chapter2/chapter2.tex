...
It can be argued that it is \emph{inconsistent} to treat bosons and fermions to zero and one loops, respectively.
...
Hence, it is equally valid to argue that our approach is \emph{consistent} in the large-$N_c$ approximation scheme.
Strictly speaking, this is only true if the number of loops is simultaneously restricted to one;
otherwise the Feynman diagram due to the $\bar{q} \sigma q$ Yukawa interaction, of order $\bigo(N_c^1)$ and with \emph{two} loops,
