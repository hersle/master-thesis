...
Solving inequality \eqref{eq:mit:bag_stability} numerically, we obtain the bag windows
\begin{subequations}
\begin{align}
...
With the equation of state, we now solve the Tolman-Oppenheimer-Volkoff equations \eqref{eq:tov:tovsys} with multiple bag pressures above the lower bounds \eqref{eq:lsm:bag_lower_bound}.
