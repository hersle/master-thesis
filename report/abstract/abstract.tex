...
\node[anchor=north west,inner sep=0pt, yshift=-2.5cm] at (current page text area.north west) {\includesvg[height=1.0cm]{figures/flag-usa.svg}};%
\end{tikzpicture}%
\tikzexternalenable%
...
\tikzexternaldisable%
\begin{tikzpicture}[remember picture, overlay]%
\node[anchor=north west,inner sep=0pt, yshift=-2.5cm] at (current page text area.north west) {\includesvg[height=1.0cm]{figures/flag-norway.svg}};%
\end{tikzpicture}%
\tikzexternalenable%
