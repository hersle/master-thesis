...
In this project, we solve the Tolman-Oppenheimer-Volkoff equation for a degenerate Fermi gas composed of free neutrons,
...
First, we derive the Tolman-Oppenheimer-Volkoff equation from the Einstein field equations
...
Next, we combine these two results by numerically integrating the Tolman-Oppenheimer-Volkoff equation
...
I dette prosjektet løser vi Tolman-Oppenheimer-Volkoff-ligningen for en degenerert Fermigass som består av frie nøytroner,
...
Først utleder vi Tolman-Oppenheimer-Volkoff-ligningen fra Einsteins feltlikninger
...
Så kombinerer vi disse to resultatene ved å numerisk integrere Tolman-Oppenheimer-Volkoff-ligningen
