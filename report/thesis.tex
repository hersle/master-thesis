...
\usepackage{microtype} % squeeze slightly-too-long title into one line
...
\usepackage{pifont}
\DeclareRobustCommand{\goldenstar}{\textcolor{Goldenrod}{\mbox{\ding{72}}}}
...
\renewcommand{\chaptermark}[1]{\markboth{Chapter \thechapter: ~ \ #1}{}} %chapter oben ohne Nummer
...
\usepackage[style=alphabetic,sorting=nyvt,giveninits=true,maxnames=10,block=space,date=iso,urldate=iso,seconds=true,language=british,maxalphanames=1]{biblatex} 
...
\TODO{capitalize chapter titles?}
