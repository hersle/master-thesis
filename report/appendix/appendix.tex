...
\subsection{The field's response to matter}
...
{\textls[-13]{CAS derivation of the Tolman-Oppenheimer-Volkoff equation}}%
{CAS derivation of the Tolman-Oppenheimer-Volkoff equation}} % force on one line
...
These programs finds all equations of state and stellar solutions in chapters \ref{chap:mit}, \ref{chap:lsm2f}, \ref{chap:lsm3f} and \ref{chap:hybrid}.
...
\node {Model}
	...
	child {node {HybridModel \\ \scriptsize \textcolor{darkgray}{(chapter 10)}}
		...
		child {node {Hybrid2FlavorConsistentModel}}
...
This file contains common code for all quark and hybrid star models
in \cref{chap:mit,chap:lsm2f,chap:lsm3f,chap:hybrid}:
\codefile{python}{../code/quark_hybrid_stars_common.py}{quark\_hybrid\_stars\_common.py}

\subsubsection{MIT bag model}
This file contains code for the MIT bag model quark stars
in \cref{chap:mit}:
\codefile{python}{../code/quark_stars_mit.py}{quark\_stars\_mit.py}

\subsubsection{Quark-meson model}
This file contains code for the quark-meson model quark stars
in \cref{chap:lsm2f,chap:lsm3f}:
\codefile{python}{../code/quark_stars_lsm.py}{quark\_stars\_lsm.py}

\subsubsection{Hybrid model}
This file contains code for the hybrid model
joining the Akmal-Pandharipande-Ravenhall (APR) hadronic equation of state from \cite{ref:apr,ref:apr_data}
with the quark-meson models in \cref{chap:lsm2f,chap:lsm3f}:
\codefile{python}{../code/hybrid_stars_apr_lsm.py}{hybrid\_stars\_apr\_lsm.py}
