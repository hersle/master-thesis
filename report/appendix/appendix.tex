...
\TODO{can i also get gravitational acceleration $\vec{g}$ in the perturbation?}
\begin{equation}
	\rho \left[ \pdv{\vec{v}}{t} + \left( \vec{v} \cdot \vec{\nabla} \right) \vec{v} \right] = -\nabla P .
\end{equation}
\TODO{what about Newt limit by $c \rightarrow \infty$?}
\TODO{make it more clear which terms are dropped and how i obtain normal Euler eq}
\TODO{reduce ALL relativistic results in this section to classical results, ref to iver fluid compendium!}
