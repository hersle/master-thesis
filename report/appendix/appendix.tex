...
\section{Parameter sweeps for 2--flavor quark stars}
\label{sec:num:qstars2f}

This program finds the solution shown in \cref{fig:lsm:2-flavor-eos-parametrization} \TODO{broken reference?} to the system of equations \eqref{eq:lsm:minsys} and the equation of state shown in \cref{fig:lsm:2-flavor-eos-eos}.
It then integrates the Tolman-Oppenheimer-Volkoff equations \TODO{reff new TOV} with this equation of state for a range of bag pressures, producing the mass-radius curves shown in \cref{fig:lsm:2-flavor-mass-radius}.
