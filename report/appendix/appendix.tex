...
\begin{equation}
	\variation{S_H} = \underbrace{\int \dif^n x \sqrt{-g} \, g^{\mu \nu} \variation{R_{\mu \nu}}}_{\textstyle \variation{S}_1}
...
\begin{equation}
	\variation{S_H} = \int \dif^n x \sqrt{-g} \left( R_{\mu \nu} - \frac{1}{2} R g_{\mu \nu} \right) \variation{g^{\mu \nu}} = 0 .
\end{equation}
...
\begin{equation}
	 \frac{1}{\sqrt{-g}} \diffv{S_H}{g^{\mu \nu}} = R_{\mu \nu} - \frac{1}{2} R g_{\mu \nu} = 0 .
\end{equation}
To get the Einstein field equations in matter, we add another contribution $S_M$ to the action that represents matter.
We also rescale the Hilbert action to end up with the correct prefactors in the end.
As our new action, we take
\begin{equation}
...
\begin{equation}
	T_{\mu \nu} = \frac{-1}{2 \sqrt{-g}} \frac{\variation{S_M}}{\variation{g^{\mu \nu}}} ,
\end{equation}
