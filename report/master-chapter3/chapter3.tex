...
The eight $SU(3)$ generators $T_a = \lambda_a/2$ are extended with the identity in the common normalization convention $\trace[T_a T_b] = \delta_{ab}/2$ of the Gell-Mann matrices
\begin{equation}
...
In particular, this vacuum expectation value must have the same vanishing electrical charge as the vacuum.
...
They can be done with pen, paper and clever use of properties of the Gell-Mann matrices, \TODO{show ``bootstrapping'' procedure for credz}
...
\end{equation}
Like we explained in \cref{chap:lsm2f},
this treatment is inconsistent in terms of the number of loops considered for the fermionic and bosonic fields,
