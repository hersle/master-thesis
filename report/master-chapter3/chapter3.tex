...
Unfortunately, this \emph{exceeds} the upper bound \eqref{eq:lsm3f:bag_upper_bound}, which was \emph{also} calculated with the strange matter hypothesis.
\emph{This means that it is not possible to self-consistently describe pure strange quark stars with this model!}
