...
\TODO{bold notation for vectors now just confusing? so drop it?}
...
\TODO{\cite{ref:lsm3f_details}: ``For $N_f=3$, the effective, low-energy degrees of freedom of QCD are the scalar and pseudoscalar mesons.''}
...
\nextgroupplot[
	...
	ymin=-20, ymax=1000, ytick distance=100, 
	%ymax=600, 
	title={\subcaption{\label{fig:lsm:3-flavor-eos-parametrization}Parametrization of solutions}},
	legend cell align=left, legend pos=north west, legend columns=5, legend transposed, reverse legend,
];
...
\addplot+ [black] {-10}; \addlegendimage{empty legend}; \addlegendentry{};
\addplot+ [black, dotted] {-100}; \addlegendentry{$m_f=m_e=0$};
...
\nextgroupplot[
	...
	legend columns=2, legend style={anchor=north, at={(0.5, 0.98)}},
];
...
\TODO{three flavor extreme star}
...
\begin{itemize}
\item \TODO{less massive than two-flavor stars}
\item \TODO{remarks}
\end{itemize}
