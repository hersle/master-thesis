\chapter{\texorpdfstring{\textls[-23]{The Three-Flavor Quark-Meson Model}}{The Three-Flavor Quark-Meson Model}}
\label{chap:lsm3f}
...
Three values are used for $m_\sigma$,
generating three parameter sets with different $m^2$, $\lambda_1$ and $m_{f_0}$.
...
\addplot3 [every axis plot post/.append style={only marks, mark=*}, mark size=1.0pt] coordinates {(300,429,+7.0)} node [above, font=\footnotesize] {minimum}; % 600
\addplot3 [every axis plot post/.append style={only marks, mark=*}, mark size=1.0pt] coordinates {(300,429,+41.6)} node [above, font=\footnotesize] {minimum}; % 700
\addplot3 [every axis plot post/.append style={only marks, mark=*}, mark size=1.0pt] coordinates {(300,429,+74.7)} node [above, font=\footnotesize] {minimum}; % 800
...
admits minima for the quark masses $m_x=g\avg{\sigma_x}/2$ and $m_y=g\avg{\sigma_y}/\sqrt{2}$
in vacuum, where $\vec{\mu}=0$,
only when fit to $m_\sigma \geq \SI{600}{\mega\electronvolt}$ at tree-level.
\TODO{add dots and text in 2F-plot}
}
\end{figure}
...
\nextgroupplot[
	...
	%ymax=600, 
	title={\subcaption{\label{fig:lsm:3-flavor-eos-parametrization}\makebox[\widthof{Parametrization of solutions}][l]{Parametrization of solutions}}},
	legend cell align=left, legend pos=north west, legend columns=5, legend transposed,
];
\addplot+ [index of colormap={1 of Set1-9}, solid, very thick, opacity=0.2, forget plot, domain=0:800] {0};
\addplot+ [index of colormap={4 of Set1-9}, solid, very thick, opacity=0.2, forget plot, domain=0:800] {0};
\addplot+ [index of colormap={6 of Set1-9}, solid, very thick, opacity=0.2, forget plot, domain=0:800] {0};
\addplot+ [index of colormap={0 of Set1-9}, solid, very thick, opacity=0.2, forget plot, domain=0:800] {x};
\addplot+ [index of colormap={2 of Set1-9}, solid, very thick, opacity=0.2, forget plot, domain=0:800] {x};

\addplot+ [index of colormap={4 of Set1-9}, solid,          very thick, opacity=1.0,            ] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mu]  {../code/data/LSM3F/eos_sigma_800.dat}; \addlegendentry{$m_x$};
\addplot+ [index of colormap={4 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mu]  {../code/data/LSM3F/eos_sigma_700.dat};
\addplot+ [index of colormap={4 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mu]  {../code/data/LSM3F/eos_sigma_600.dat};
\addplot+ [index of colormap={6 of Set1-9}, solid,          very thick, opacity=1.0,            ] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ms]  {../code/data/LSM3F/eos_sigma_800.dat}; \addlegendentry{$m_y$};
\addplot+ [index of colormap={6 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ms]  {../code/data/LSM3F/eos_sigma_700.dat};
\addplot+ [index of colormap={6 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ms]  {../code/data/LSM3F/eos_sigma_600.dat};
\addplot+ [index of colormap={0 of Set1-9}, solid,          very thick, opacity=1.0,            ] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=muu] {../code/data/LSM3F/eos_sigma_800.dat}; \addlegendentry{$\mu_u$};
\addplot+ [index of colormap={0 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=muu] {../code/data/LSM3F/eos_sigma_700.dat};
\addplot+ [index of colormap={0 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=muu] {../code/data/LSM3F/eos_sigma_600.dat};
\addplot+ [index of colormap={2 of Set1-9}, solid,          very thick, opacity=1.0,            ] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mud] {../code/data/LSM3F/eos_sigma_800.dat}; \addlegendentry{$\mu_d=\mu_s$};
\addplot+ [index of colormap={2 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mud] {../code/data/LSM3F/eos_sigma_700.dat};
\addplot+ [index of colormap={2 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mud] {../code/data/LSM3F/eos_sigma_600.dat};
\addplot+ [index of colormap={2 of Set1-9}, solid,          very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mus] {../code/data/LSM3F/eos_sigma_800.dat}; %\addlegendentry{$\mu_s$};
\addplot+ [index of colormap={2 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mus] {../code/data/LSM3F/eos_sigma_700.dat};
\addplot+ [index of colormap={2 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mus] {../code/data/LSM3F/eos_sigma_600.dat};
\addplot+ [index of colormap={1 of Set1-9}, solid,          very thick, opacity=1.0,            ] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mue] {../code/data/LSM3F/eos_sigma_800.dat}; \addlegendentry{$\mu_e$};
\addplot+ [index of colormap={1 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mue] {../code/data/LSM3F/eos_sigma_700.dat};
\addplot+ [index of colormap={1 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=mue] {../code/data/LSM3F/eos_sigma_600.dat};

\addplot+ [black, solid, very thick] {-100}; \addlegendentry{$m_\sigma=\SI{800}{\mega\electronvolt}$};
\addplot+ [black, densely dashed, very thick] {-100}; \addlegendentry{$m_\sigma=\SI{700}{\mega\electronvolt}$};
\addplot+ [black, densely dotted, very thick] {-100}; \addlegendentry{$m_\sigma=\SI{600}{\mega\electronvolt}$};
...
\nextgroupplot[
	...
	title={\subcaption{\label{fig:lsm:3-flavor-eos-density}\makebox[\widthof{Parametrization of solutions}][l]{Particle number densities}}},
...
\addplot+ [index of colormap={1 of Set1-9}, solid, very thick,  opacity=0.2, forget plot, domain=0:700] {0};
\addplot+ [index of colormap={0 of Set1-9}, solid, very thick,  opacity=0.2, forget plot, domain=0:700] {nq3(x)*nconv};
\addplot+ [index of colormap={6 of Set1-9}, solid, very thick, opacity=0.2, forget plot, domain=0:700] {nq3(x)*nconv};
\addplot+ [index of colormap={2 of Set1-9}, solid, very thick, opacity=0.2, forget plot, domain=0:700] {nq3(x)*nconv};

\addplot+ [index of colormap={0 of Set1-9}, solid,          very thick, opacity=1.0,            ] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nu] {../code/data/LSM3F/eos_sigma_800.dat}; \addlegendentry{$n_u$};
\addplot+ [index of colormap={0 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nu] {../code/data/LSM3F/eos_sigma_700.dat};
\addplot+ [index of colormap={0 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nu] {../code/data/LSM3F/eos_sigma_600.dat};
\addplot+ [index of colormap={2 of Set1-9}, solid,          very thick, opacity=1.0,            ] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nd] {../code/data/LSM3F/eos_sigma_800.dat}; \addlegendentry{$n_d$};
\addplot+ [index of colormap={2 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nd] {../code/data/LSM3F/eos_sigma_700.dat};
\addplot+ [index of colormap={2 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=nd] {../code/data/LSM3F/eos_sigma_600.dat};
\addplot+ [index of colormap={6 of Set1-9}, solid,          very thick, opacity=1.0,            ] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ns] {../code/data/LSM3F/eos_sigma_800.dat}; \addlegendentry{$n_s$};
\addplot+ [index of colormap={6 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ns] {../code/data/LSM3F/eos_sigma_700.dat};
\addplot+ [index of colormap={6 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ns] {../code/data/LSM3F/eos_sigma_600.dat};
\addplot+ [index of colormap={1 of Set1-9}, solid,          very thick, opacity=1.0,            ] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ne] {../code/data/LSM3F/eos_sigma_800.dat}; \addlegendentry{$n_e$};
\addplot+ [index of colormap={1 of Set1-9}, densely dashed, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ne] {../code/data/LSM3F/eos_sigma_700.dat};
\addplot+ [index of colormap={1 of Set1-9}, densely dotted, very thick, opacity=1.0, forget plot] table [x expr={(\thisrow{muu}+\thisrow{mud})/2}, y=ne] {../code/data/LSM3F/eos_sigma_600.dat};

\addplot+ [black, solid, very thick] {-1}; \addlegendentry{$m_\sigma=\SI{800}{\mega\electronvolt}$};
\addplot+ [black, densely dashed, very thick] {-1}; \addlegendentry{$m_\sigma=\SI{700}{\mega\electronvolt}$};
\addplot+ [black, densely dotted, very thick] {-1}; \addlegendentry{$m_\sigma=\SI{600}{\mega\electronvolt}$};
\addplot+ [black, solid, very thick, opacity=0.2] {-1}; \addlegendentry{$m_{\phantom{\sigma}}=0$};

\nextgroupplot[
	xlabel={$P        \, / \, (\si{\giga\electronvolt\per\femto\meter\cubed})$},
	ylabel={$\epsilon \, / \, (\si{\giga\electronvolt\per\femto\meter\cubed})$},
	xmin=-0.005, xmax=0.8, ymin=0, ymax=4.0, xtick distance=0.1, ytick distance=1.0, minor y tick num=9, restrict y to domain=-10:+10,
	title={\subcaption{\label{fig:lsm:3-flavor-eos-eos}\makebox[\widthof{Parametrization of solutions}][l]{Equation of state}} },
	legend cell align=left, legend pos=north west, legend columns=4, legend transposed,
];
...
\addplot+ [black, solid, very thick, opacity=1.0] table [x=P,y=epsilon] {../code/data/LSM3F/eos_sigma_800.dat}; \addlegendentry{$m_\sigma=\SI{800}{\mega\electronvolt}$};
\addplot+ [gray,  densely dashed, very thick, opacity=1.0, forget plot] table [x=Porg,y=epsilonorg] {../code/data/LSM3F/eos_sigma_700.dat};
\addplot+ [black, densely dashed, very thick, opacity=1.0] table [x=P,y=epsilon] {../code/data/LSM3F/eos_sigma_700.dat}; \addlegendentry{$m_\sigma=\SI{700}{\mega\electronvolt}$};
\addplot+ [gray,  densely dotted, very thick, opacity=1.0, forget plot] table [x=Porg,y=epsilonorg] {../code/data/LSM3F/eos_sigma_600.dat};
\addplot+ [black, densely dotted, very thick, opacity=1.0] table [x=P,y=epsilon] {../code/data/LSM3F/eos_sigma_600.dat}; \addlegendentry{$m_\sigma=\SI{600}{\mega\electronvolt}$};
\addplot+ [black, solid, very thick, opacity=0.2, domain=0:3.0] {3*x}; \addlegendentry{$m_{\phantom{\sigma}}=0$};
...
\node [anchor=south west] at (zoomplot) {
	...
	\addplot+ [black, solid, very thick, opacity=1.0] table [x=P,y=epsilon] {../code/data/LSM3F/eos_sigma_800.dat};
	\addplot+ [gray, densely dashed, very thick, opacity=1.0] table [x=Porg,y=epsilonorg] {../code/data/LSM3F/eos_sigma_700.dat};
	\addplot+ [black, densely dashed, very thick, opacity=1.0] table [x=P,y=epsilon] {../code/data/LSM3F/eos_sigma_700.dat};
	\addplot+ [gray, densely dotted, very thick, opacity=1.0] table [x=Porg,y=epsilonorg] {../code/data/LSM3F/eos_sigma_600.dat};
	\addplot+ [black, densely dotted, very thick, opacity=1.0] table [x=P,y=epsilon] {../code/data/LSM3F/eos_sigma_600.dat};
	\addplot+ [black, solid, very thick, very thick, opacity=0.2, domain=0:0.05] {3*x};
	\end{axis}
	\end{tikzpicture}
};
\end{tikzpicture}
\caption{\label{fig:lsm:3-flavor-eos}%
Properties of charge-neutral quark matter in $\beta$-equilibrium in the three-flavor quark meson model.
Upper panel \subref{fig:lsm:3-flavor-eos-parametrization} shows solutions to equation \eqref{eq:lsm3f:minsys},
middle panel \subref{fig:lsm:3-flavor-eos-density} the particle number densities \eqref{eq:lsm3f:particle_densities} and
lower panel \subref{fig:lsm:3-flavor-eos-eos} the equation of state $\epsilon(P)$ \textbf{\textcolor{gray}{before}} and \textbf{after} the Maxwell construction.
Parameter sets with $m_\sigma=\{600,700,800\}\si{\mega\electronvolt}$ from \cref{tab:lsm3f:parameters} are used.
The weak lines show the solutions \eqref{eq:mit:densities_massless}, \eqref{eq:mit:eos_ur} and \eqref{eq:mit:chemical_potentials_massless_3f}
...
\addplot [index of colormap={0 of Set1-9}, very thick] table [x expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/sat/3}, y expr={3*\thisrow{nu}/(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})}] {../code/data/LSM3F/eos.dat};
\addlegendentry{$n_u$};
\addplot [index of colormap={2 of Set1-9}, very thick] table [x expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/sat/3}, y expr={3*\thisrow{nd}/(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})}] {../code/data/LSM3F/eos.dat};
\addlegendentry{$n_d$};
\addplot [index of colormap={6 of Set1-9}, very thick] table [x expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/sat/3}, y expr={3*\thisrow{ns}/(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})}] {../code/data/LSM3F/eos.dat};
\addlegendentry{$n_s$};
\addplot [index of colormap={1 of Set1-9}, very thick] table [x expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/sat/3}, y expr={3*\thisrow{ne}/(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})}] {../code/data/LSM3F/eos.dat};
\addlegendentry{$n_e$};
\end{axis}
\end{tikzpicture}
...
\addplot+ [solid, gray, very thick, opacity=0.5] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_600_B14_111.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, gray, very thick, opacity=0.5, forget plot] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_600_B14_131.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, gray, very thick, opacity=0.5, forget plot] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_600_B14_151.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addlegendentry{$N_f \!=\! 2$};
\addplot+ [solid, mesh, very thick, mesh line legend] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F/stars_sigma_600_B14_111.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, mesh, very thick, forget plot] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F/stars_sigma_600_B14_131.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, mesh, very thick, forget plot] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F/stars_sigma_600_B14_151.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
...
\addplot+ [solid, gray, very thick, opacity=0.5] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_700_B14_68.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, gray, very thick, opacity=0.5, forget plot] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_700_B14_88.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, gray, very thick, opacity=0.5, forget plot] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_700_B14_108.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addlegendentry{$N_f=2$};
\addplot+ [solid, mesh, very thick, mesh line legend] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F/stars_sigma_700_B14_68.dat};  % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, mesh, very thick, forget plot] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F/stars_sigma_700_B14_88.dat};  % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, mesh, very thick, forget plot] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F/stars_sigma_700_B14_108.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addlegendentry{$N_f=3$};
...
\addplot+ [solid, gray, very thick, opacity=0.5] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_800_B14_27.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, gray, very thick, opacity=0.5, forget plot] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_800_B14_47.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, gray, very thick, opacity=0.5, forget plot] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM2F/stars_sigma_800_B14_67.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addlegendentry{$N_f=2$};
\addplot+ [solid, mesh, very thick, mesh line legend] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F/stars_sigma_800_B14_27.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, mesh, very thick, forget plot] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F/stars_sigma_800_B14_47.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addplot+ [solid, mesh, very thick, forget plot] table [x=R, y=M, meta expr={log10(\thisrow{P}*e0)}] {../code/data/LSM3F/stars_sigma_800_B14_67.dat}; % node [Bpin, pos=0.920] {$B = (\SI{27}{\mega\electronvolt})^4$};
\addlegendentry{$N_f=3$};
...
\addplot+ [index of colormap={1 of Set1-9}, very thick] table [x=r, y=epsilon] {../code/data/LSM3F/star_sigma_800_B14_27_Pc_0.0009376.dat}; \addlegendentry{$\epsilon$};
\addplot+ [index of colormap={0 of Set1-9}, very thick] table [x=r, y=P] {../code/data/LSM3F/star_sigma_800_B14_27_Pc_0.0009376.dat}; \addlegendentry{$P$};
\nextgroupplot[
	ylabel=$m \, / \, M_\odot$,
	xticklabels={,,},
	ymax=2, ytick distance=0.5, minor y tick num=4,
];
\addplot+ [black, very thick] table [x=r, y=m] {../code/data/LSM3F/star_sigma_800_B14_27_Pc_0.0009376.dat};
\nextgroupplot[
	xlabel=$r \, / \, \si{\kilo\meter}$,
	ylabel=$\mu \, / \, \si{\mega\electronvolt}$,
	ymin=300, ymax=500, ytick distance=50, minor y tick num=4,
];
\addplot+ [black, very thick] table [x=r, y=muQ] {../code/data/LSM3F/star_sigma_800_B14_27_Pc_0.0009376.dat};
\nextgroupplot[
	xlabel=$r \, / \, \si{\kilo\meter}$,
	ylabel=$n_i \, / \, n_\text{sat}$,
	ymax=15, ytick distance=5, minor y tick num=4,
];
\addplot+ [index of colormap={0 of Set1-9}, very thick] table [x=r, y=nu] {../code/data/LSM3F/star_sigma_800_B14_27_Pc_0.0009376.dat}; \addlegendentry{$n_u$};
\addplot+ [index of colormap={2 of Set1-9}, very thick] table [x=r, y=nd] {../code/data/LSM3F/star_sigma_800_B14_27_Pc_0.0009376.dat}; \addlegendentry{$n_d$};
\addplot+ [index of colormap={6 of Set1-9}, very thick] table [x=r, y=ns] {../code/data/LSM3F/star_sigma_800_B14_27_Pc_0.0009376.dat}; \addlegendentry{$n_s$};
\addplot+ [index of colormap={1 of Set1-9}, very thick] table [x=r, y=ne] {../code/data/LSM3F/star_sigma_800_B14_27_Pc_0.0009376.dat}; \addlegendentry{$n_e$};
\addplot+ [black, dashed, very thick, forget plot] table [x=r, y expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/3}] {../code/data/LSM3F/star_sigma_800_B14_27_Pc_0.0009376.dat};
% cheat legend
\addplot+ [draw=none, black, solid, very thick] table [x=r, y expr={(\thisrow{nu}+\thisrow{nd}+\thisrow{ns})/3}] {../code/data/LSM3F/star_sigma_800_B14_27_Pc_0.0009376.dat}; \addlegendentry{$n_B$};
\end{groupplot}
...
\addplot+ [black, very thick, densely dotted] table [x expr={(\thisrow{muu}+\thisrow{mud}) / 2}, y expr={sign(\thisrow{Porg})*abs(\thisrow{Porg}/conv)^0.25}] {../code/data/LSM3F/eos_sigma_600.dat}; \addlegendentry{$m_\sigma=\SI{600}{\mega\electronvolt}$};
\addplot+ [black, very thick, densely dashed] table [x expr={(\thisrow{muu}+\thisrow{mud}) / 2}, y expr={sign(\thisrow{Porg})*abs(\thisrow{Porg}/conv)^0.25}] {../code/data/LSM3F/eos_sigma_700.dat}; \addlegendentry{$m_\sigma=\SI{700}{\mega\electronvolt}$};
\addplot+ [black, very thick, solid]          table [x expr={(\thisrow{muu}+\thisrow{mud}) / 2}, y expr={sign(\thisrow{Porg})*abs(\thisrow{Porg}/conv)^0.25}] {../code/data/LSM3F/eos_sigma_800.dat}; \addlegendentry{$m_\sigma=\SI{800}{\mega\electronvolt}$};
\end{axis}
\end{tikzpicture}
\caption{\label{fig:lsm:3-flavor-pressure}%
	...
	for the equations of state in \cref{fig:lsm:3-flavor-eos-eos},
