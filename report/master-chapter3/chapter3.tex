...
Unfortunately, we fail to model entirely strange quark stars with this model.
...
increasing the bag constant beyond its upper bound that is \emph{also} calculated with the strange matter hypothesis,
hence contradicting it.
