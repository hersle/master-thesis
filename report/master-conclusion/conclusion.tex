...
This resonates with the general view that hybrid star quark cores are generally small. \cite{ref:quark_star_review} \TODO{cite ref 104 within? YES! look at eq 15! compare with my results? add all $N_f=\{2,3\}$ EOSes in one/two additional plots and check if this is indeed satisfised in chapter 4?}
...
they find hybrid stars a similar maximum mass $M \lesssim 1.9 M_\odot$ in \cite[figure 8]{ref:lsm3f_hybrid_stars}. % only B differs?
