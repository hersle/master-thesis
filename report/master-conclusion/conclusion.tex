...
\ploteverything
\coordinate (zoomplot) at (15.8, 2.4);
\end{axis}
\node [anchor=north east] at (zoomplot) {
	...
	\begin{axis}[
		...
		xmin=11, xmax=12, ymin=1.85, ymax=2.15, xtick distance=1.0, ytick distance=0.5, minor x tick num=9, minor y tick num=4, extra y ticks={1.9, 2.1},
		grid=both, minor grid style={ultra thin, gray!10!white},
	]
	\ploteverything
	\legend{};
