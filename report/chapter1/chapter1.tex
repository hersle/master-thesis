...
Indeed, we should have $1 - 2 G m(r) / c^2 r > 0$ for all $r$, for otherwise the region inside would be a black hole.
...
In summary, we have shown that \emph{both the pressure and energy density strictly decreases away from the center}.
...
\TODO{continue here on Thursday}
