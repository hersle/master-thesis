...
\addplot+ [red,   dashed] table [x=mu, y=nu] {../code/data/2flavfreeeos.dat}; \addlegendentry{freee up quarks};
...
\addplot+ [black,  solid] table [x=P,y=epsilon] {../code/data/2flaveos.dat}; \addlegendentry{with interaction};
\addplot+ [black, dashed] table [x=P,y=epsilon] {../code/data/2flavfreeeos.dat}; \addlegendentry{without interactions};
\end{groupplot}
\end{tikzpicture}
