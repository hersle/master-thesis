...
\addplot+ [orange, solid] table [x=mu,y=sigma] {../code/data/2flaveos.dat};
\addlegendentry{$\avg{\sigma} \, / \, \si{\mega\electronvolt}$};
\addplot+ [red,   dashed] table [x=mu,y=muu  ] {../code/data/2flavfreeeos.dat};
\addplot+ [red,    solid] table [x=mu,y=muu  ] {../code/data/2flaveos.dat};
\addlegendentry{$\mu_u \, / \, \si{\mega\electronvolt}$};
\addplot+ [green, dashed] table [x=mu,y=mud  ] {../code/data/2flavfreeeos.dat};
\addplot+ [green,  solid] table [x=mu,y=mud  ] {../code/data/2flaveos.dat};
\addlegendentry{$\mu_d \, / \, \si{\mega\electronvolt}$};
\addplot+ [black, dashed] table [x=mu,y=mue  ] {../code/data/2flavfreeeos.dat};
\addplot+ [black,  solid] table [x=mu,y=mue  ] {../code/data/2flaveos.dat};
\addlegendentry{$\mu_e \, / \, \si{\mega\electronvolt}$};

\nextgroupplot[
	xlabel={$\mu \, / \, \si{\mega\electronvolt}$}, ylabel={$n \, / \, (1/\si{\femto\meter\cubed})$},
	xmin=0, xmax=600,
	ymax=2.0, ytick distance=0.5,
	%xmin=600, xmax=1400,
...
\addplot+ [red,    solid] table [x=mu, y=nu] {../code/data/2flaveos.dat}; \addlegendentry{up quarks};
\addplot+ [red,   dashed] table [x=mu, y=nu] {../code/data/2flavfreeeos.dat}; \addlegendentry{free up quarks};
\addplot+ [green,  solid] table [x=mu, y=nd] {../code/data/2flaveos.dat}; \addlegendentry{down quarks};
\addplot+ [green, dashed] table [x=mu, y=nd] {../code/data/2flavfreeeos.dat}; \addlegendentry{free down quarks};
\addplot+ [black,  solid] table [x=mu, y=ne] {../code/data/2flaveos.dat}; \addlegendentry{electrons};
\addplot+ [black, dashed] table [x=mu, y=ne] {../code/data/2flavfreeeos.dat}; \addlegendentry{free electrons};
...
\addplot+ [black,  solid] table [x=P,y=epsilon] {../code/data/2flaveos.dat}; \addlegendentry{two-flavor interacting quark matter};
\addplot+ [black, dashed] table [x=P,y=epsilon] {../code/data/2flavfreeeos.dat}; \addlegendentry{two-flavor free quark matter};
\end{groupplot}
\end{tikzpicture}
\caption{\label{fig:lsm:2-flavor-eos}%
\subref{fig:lsm:2-flavor-eos-parametrization} Solutions to the system of equations \eqref{eq:lsm:minsys} describing charge neutral two-flavor quark matter in $\beta$-equilibrium, parametrized by the quark chemical potential $\mu = (\mu_u+\mu_d)/2$.
\subref{fig:lsm:2-flavor-eos-density} Corresponding particle number densities \eqref{eq:lsm:particle_densities}.
\subref{fig:lsm:2-flavor-eos-eos} Corresponding equation of state with no bag constant, found by eliminating the chemical potential from the pressure \eqref{eq:lsm:pressure_bagless} and energy density \eqref{eq:lsm:energy_density_bagless}.
\TODO{compare with free quark gas}
}
\end{figure}
