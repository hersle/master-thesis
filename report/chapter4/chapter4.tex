...
\TODO{write down explicit entries}
\begin{subequations}
\begin{align}
...
\TODO{needs $\avg{\sigma}$. but too long. switch notation to $\bar{\sigma}$ (classical) and $\tilde{\sigma}$ (quantum fluctuation)}
\begin{equation}
\begin{split}
...
\TODO{write down masses $\sigma$, $f_0$, $a$, $\pi$, $K$, $\kappa$, etc. in terms of $m^2_{ab}$ from TODO above (see written paper)}
\TODO{need new avg notation}
\begin{subequations}
\begin{align}
	m^2_\sigma &= m^2 + 2 \lambda_1 \big( \avg{\sigma_x}^2 + \avg{\sigma_y}^2 \big) + \frac{3 \lambda_2}{4} \big( \avg{\sigma_x}^2 + 2 \avg{\sigma_y}^2 \big) - \Delta_\sigma \\
	m^2_{f_0}  &= m^2 + 2 \lambda_1 \big( \avg{\sigma_x}^2 + \avg{\sigma_y}^2 \big) + \frac{3 \lambda_2}{4} \big( \avg{\sigma_x}^2 + 2 \avg{\sigma_y}^2 \big) + \Delta_\sigma \\
	m^2_a      &= m^2 + \lambda_1 \big(\sigma_x^2 + \sigma_y^2\big) + \frac{3}{2} \lambda_2 \sigma_x^2 \\
	m^2_\kappa &= m^2 + \lambda_1 \big(\sigma_x^2 + \sigma_y^2\big) + \frac{\lambda_2}{2} \big(\sqrt{2} \sigma_x \sigma_y + \sigma_x^2 + 2 \sigma_y^2\big) \\
	m^2_{\eta} &= m^2 + \lambda_1 \big(\sigma_x^2 + \sigma_y^2\big) + \frac{\lambda_2}{4} \big(\sigma_x^2 + 2 \sigma_y^2\big) - \Delta_\pi \\
	m^2_{\eta'}&= m^2 + \lambda_1 \big(\sigma_x^2 + \sigma_y^2\big) + \frac{\lambda_2}{4} \big(\sigma_x^2 + 2 \sigma_y^2\big) + \Delta_\pi \\
	m^2_\pi    &= m^2 + \lambda_1 \big( \avg{\sigma_x}^2 + \avg{\sigma_y}^2 \big) + \frac{\lambda_2}{2} \avg{\sigma_x}^2, \\
	m^2_K      &= m^2 + \lambda_1 \big( \avg{\sigma_x}^2 + \avg{\sigma_y}^2 \big) + \frac{\lambda_2}{2} \big( \avg{\sigma_x}^2 + 2 \avg{\sigma_y}^2 - \sqrt{2} \avg{\sigma_x} \avg{\sigma_y} \big),
\end{align}%
...
\begin{equation}
\begin{split}
	\Delta_\sigma = \frac{1}{4} \Big[ & 16 \lambda_1^2 \big( \avg{\sigma_x}^2 + \avg{\sigma_y}^2 \big)^2 + 9 \lambda_2^2 \big( \avg{\sigma_x}^4 - 4 \avg{\sigma_x}^2 \avg{\sigma_y}^2 + 4 \avg{\sigma_y}^4 \big) \, + \\
	                                  & 24 \lambda_1 \lambda_2 \big( \avg{\sigma_x}^4 - 3 \avg{\sigma_x}^2 \avg{\sigma_y}^2 + 2 \avg{\sigma_y}^4 \big) \Big]^{\frac12},
\end{split}
\end{equation}
and
\begin{equation}
	\Delta_\pi = \frac{\lambda_2}{12} \sqrt{6 \sqrt{2} \sigma_x \sigma_y + 3 \sigma_x^2 + 6 \sigma_y^2} \big( \sqrt{6} \sigma_y - \sqrt{3} \sigma_x \big).
\end{equation}
\TODO{remark on which masses come from which matrix elements, and particle types}
From any three experimental values of these masses, we can fit the parameters $m^2$, $\lambda_1$ and $\lambda_2$, and predict the five others.
