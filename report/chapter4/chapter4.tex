...
We can make a very simple classical argument for why there can be no \emph{global} electric charge in stars by comparing Newton's law of gravity and Coulomb's law.
Consider a test particle of mass $m$ and electric charge $q$ at the surface $R$ from the center of a star with total mass $M$ and electric charge $Q$.
