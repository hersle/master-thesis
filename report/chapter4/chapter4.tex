...
The location of the nonzero minima \eqref{eq:lsm:ground_state_3f} can then be expressed in terms of the symmetry breakers $h_x$ and $h_y$ \TODO{not defined?} through
\begin{subequations}
\begin{align}
	0 &= \pdv{\pot}{\sigma_x}_{(\sigma,\pi)=(\avg{\sigma},\avg{\pi})} = \avg{\sigma_x} \Big[ m^2 + \lambda_1 \big( \avg{\sigma_x}^2 + \avg{\sigma_y}^2 \big) + \frac12 \lambda_2 \avg{\sigma_y}^2 \Big] - h_x, \\
...
\end{align}%
\end{subequations}%
The mixed mass matrix $m^2_{\sigma\pi} = 0$ vanishes completely because the partial derivative always leaves terms with factors $\pi_a$ that vanishes when evaluated in the ground state \eqref{eq:lsm:ground_state_3f},
