...
\addplot3 [surf, very thin, mesh/ordering=x varies] table [x=sigma, y=muu, z=omega] {../code/data/lsmpot_nonneutral.dat};
\addplot3 [red]  table [x=sigma, y=muu, z=omega] {../code/data/lsmpot_nonneutral_min.dat}; % plot line of minima
\addplot  [gray] table [x=sigma, y=muu, z expr={-160}] {../code/data/lsmpot_nonneutral_min.dat}; % plot its "shadow" in bottom plane
\end{axis}
\end{tikzpicture}
\caption{\label{fig:lsm:grand_potential}%
Grand potential without charge neutrality ($\mu_u = \mu_d$, $\mu_e$ = 0).
}
\end{figure}

\begin{figure}
\tikzsetnextfilename{grand-potential-neutral-left}
\begin{tikzpicture}
\begin{axis}[
	view={147}{18},
	width=14cm, height=13cm,
...
\addplot3 [surf, very thin, mesh/ordering=x varies] table [x=sigma, y=muu, z=omega] {../code/data/lsmpot_neutral_left.dat};
\addplot3 [red]  table [x=sigma, y=muu, z=omega] {../code/data/lsmpot_neutral_left_min.dat}; % plot line of minima
\addplot  [gray] table [x=sigma, y=muu, z expr={-160}] {../code/data/lsmpot_neutral_left_min.dat}; % plot its "shadow" in bottom plane
\end{axis}
\end{tikzpicture}
\caption{\label{fig:lsm:grand_potential}%
Grand potential with ``left'' charge neutrality solution.
}
\end{figure}

\begin{figure}
\tikzsetnextfilename{grand-potential-neutral-right}
\begin{tikzpicture}
\begin{axis}[
	view={147}{18},
	width=14cm, height=13cm,
...
\addplot3 [surf, very thin, mesh/ordering=x varies] table [x=sigma, y=muu, z=omega] {../code/data/lsmpot_neutral_right.dat};
\addplot3 [red]  table [x=sigma, y=muu, z=omega] {../code/data/lsmpot_neutral_right_min.dat}; % plot line of minima
\addplot  [gray] table [x=sigma, y=muu, z expr={-160}] {../code/data/lsmpot_neutral_right_min.dat}; % plot its "shadow" in bottom plane
\end{axis}
\end{tikzpicture}
\caption{\label{fig:lsm:grand_potential}%
Grand potential with ``right'' charge neutrality solution.
}
\end{figure}
