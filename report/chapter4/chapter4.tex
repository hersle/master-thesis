...
\begin{axis}[
	...
	xlabel = {$r \, / \, \si{\kilo\meter}$}, ylabel = {$n_i \, / \, (1/\si{\femto\meter\cubed})$},
	enlarge x limits = false,
	xtick distance=1.0, minor x tick num=9,
	ymin=-0.1, ymax=2, ytick distance=0.5, minor y tick num=4,
	cycle multi list = {
		blue,red,darkgreen,purple\nextlist
		opacity=0.5,opacity=0.75,opacity=1.0
	},
...
\addplot [black, opacity=0.5] {-1}; \addlegendentry{$P_c = 10^{34.41} \, \si{\pascal}$};
\addplot [black, opacity=0.75] {-1}; \addlegendentry{$P_c = 10^{34.53} \, \si{\pascal}$};
\addplot [black, opacity=1.0] {-1}; \addlegendentry{$P_c = 10^{34.63} \, \si{\pascal}$};
\pgfplotsset{cycle list shift=-7};

\pgfplotsinvokeforeach{0,1,2}{
	\addplot table [x=r#1, y=ne#1] {../code/data/quarkstar3f_B14_38_densities.dat};
}
\pgfplotsinvokeforeach{0,1,2}{
	\addplot table [x=r#1, y=nu#1] {../code/data/quarkstar3f_B14_38_densities.dat};
}
\pgfplotsinvokeforeach{0,1,2}{
	\addplot table [x=r#1, y=nd#1] {../code/data/quarkstar3f_B14_38_densities.dat};
}
\pgfplotsinvokeforeach{0,1,2}{
	\addplot table [x=r#1, y=ns#1] {../code/data/quarkstar3f_B14_38_densities.dat};
}
\end{axis}
\end{tikzpicture}
