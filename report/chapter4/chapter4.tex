...
We fit the six model parameters $g$, $m^2$, $\lambda_1$, $\lambda_2$, $h_x$ and $h_8$ in vacuum,
...
we determine the three parameters $m^2$, $\lambda_1$ and $\lambda_2$ and predict the remaining meson masses.
Then it is straightforward to calculate the symmetry breaking parameters \eqref{eq:lsm3f:symmetry_breakers}.
Likewise, we use one of the quark masses \eqref{eq:lsm:quark_masses_3f} to determine the parameter $g$ and predict the other quark mass.
\Cref{tab:lsm3f:parameters} shows the numerical values used in the fit and the predicted particle masses.

\TODO{comment on mismatches, this is improved by including anomaly ($c \neq 0$), as done in \cite{ref:lsm3f}}
