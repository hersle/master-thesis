...
Proportions of each particle density $n_i$ from \cref{fig:lsm:3-flavor-eos-density} \TODO{this and other refs are incorrect!} to the total density $n_\text{tot} = n_u + n_d + n_s + n_e$
...
The baryon density is shown in units of the nuclear saturation density $n_\text{sat} = \SI{0.165}{\per\femto\meter\cubed}$ at which nuclei begin to overlap.
