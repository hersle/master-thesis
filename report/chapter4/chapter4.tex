...
\addplot+ [black, dashed] table [x=mub,y=sigma] {../code/data/2flaveos.dat};
\addlegendentry{$\avg{\sigma} \, / \, \si{\mega\electronvolt}$};
\addplot+ [red   ] table [x=mub,y=muu  ] {../code/data/2flaveos.dat};
\addlegendentry{$\mu_u \, / \, \si{\mega\electronvolt}$};
\addplot+ [green ] table [x=mub,y=mud  ] {../code/data/2flaveos.dat};
\addlegendentry{$\mu_d \, / \, \si{\mega\electronvolt}$};
\addplot+ [black ] table [x=mub,y=mue  ] {../code/data/2flaveos.dat};
\addlegendentry{$\mu_e \, / \, \si{\mega\electronvolt}$};

\nextgroupplot[
	xlabel={$\mu_B \, / \, \si{\mega\electronvolt}$}, ylabel={$n \, / \, (1/\si{\femto\meter\cubed})$},
	xmin=600, xmax=1400,
...
\addplot+ [red] table [x=mub,y=nu] {../code/data/2flaveos.dat}; \addlegendentry{up quarks};
\addplot+ [green] table [x=mub,y=nd] {../code/data/2flaveos.dat}; \addlegendentry{down quarks};
\addplot+ [black] table [x=mub,y=ne] {../code/data/2flaveos.dat}; \addlegendentry{electrons};
...
\TODO{should get $m_\sigma = 800$ to work! fix parameter choices. so far I have only gotten $m_\sigma = \SI{900}{\mega\electronvolt}$ to work.}
