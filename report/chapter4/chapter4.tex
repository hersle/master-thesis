...
motivated by the faint \TODO{very low?} electron density in the numerical solution.
...
\end{itemize}
\TODO{need reference for ``alternative'' particles. check all $\pm$ signs!!}
...
\TODO{1/2 in $\mu_I$ also works and is more natural with what I already have}
\TODO{why these? why not $\mu = (\mu_u+\mu_d+\mu_s)/3$ or something that corresponds to total quark density?}
\TODO{use a chemical potential corresponding to total quark density?}
\TODO{add reference}
...
\begin{equation}
	\mu_u = \mu + \frac12 \mu_I, \qquad
	\mu_d = \mu - \frac12 \mu_I, \qquad
	\mu_s = \mu - \mu_S ,
\end{equation}
