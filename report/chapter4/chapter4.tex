...
\addplot+ [red]   table [x=mu, y expr={\thisrow{nu}}] {../code/data/2flaveos.dat}; \addlegendentry{up quarks};
\addplot+ [green] table [x=mu, y expr={\thisrow{nd}}] {../code/data/2flaveos.dat}; \addlegendentry{down quarks};
\addplot+ [black] table [x=mu, y expr={\thisrow{ne}}] {../code/data/2flaveos.dat}; \addlegendentry{electrons};
