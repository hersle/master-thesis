...
\addplot+ [blue,      solid, opacity=0.7             ] table [x=muQ, y=mue]    {../code/data/LSM3F/eos_sigma_700.dat}; \addlegendentry{$\mu_e \, / \, \si{\mega\electronvolt}$};
\addplot+ [blue,      solid, opacity=0.7, forget plot] table [x=muQ, y=mue]    {../code/data/LSM3F/eos_sigma_800.dat};
\addplot+ [darkgreen, solid, opacity=0.7             ] table [x=muQ, y=mud]    {../code/data/LSM3F/eos_sigma_700.dat}; \addlegendentry{$\mu_d \, / \, \si{\mega\electronvolt}$};
\addplot+ [darkgreen, solid, opacity=0.7, forget plot] table [x=muQ, y=mud]    {../code/data/LSM3F/eos_sigma_800.dat};
\addplot+ [red,       solid, opacity=0.7             ] table [x=muQ, y=muu]    {../code/data/LSM3F/eos_sigma_700.dat}; \addlegendentry{$\mu_u \, / \, \si{\mega\electronvolt}$};
\addplot+ [red,       solid, opacity=0.7, forget plot] table [x=muQ, y=muu]    {../code/data/LSM3F/eos_sigma_800.dat};
\addplot+ [yellow,    solid, opacity=0.7             ] table [x=muQ, y=Deltay] {../code/data/LSM3F/eos_sigma_700.dat}; \addlegendentry{$\Delta_y \, / \, \si{\mega\electronvolt}$};
\addplot+ [yellow,    solid, opacity=0.7, forget plot] table [x=muQ, y=Deltay] {../code/data/LSM3F/eos_sigma_800.dat};
\addplot+ [orange,    solid, opacity=0.7             ] table [x=muQ, y=Deltax] {../code/data/LSM3F/eos_sigma_700.dat}; \addlegendentry{$\Delta_x \, / \, \si{\mega\electronvolt}$};
\addplot+ [orange,    solid, opacity=0.7, forget plot] table [x=muQ, y=Deltax] {../code/data/LSM3F/eos_sigma_800.dat};

\nextgroupplot[
	xlabel={$\mu_Q \, / \, \si{\mega\electronvolt}$}, ylabel={$n_i \, / \, (1/\si{\femto\meter\cubed})$},
	xmin=0, xmax=800, xtick distance=100, minor x tick num=9,
	ymax=3.0, ytick distance=0.5, minor y tick num=4, restrict y to domain=-10:10,
...
\addplot+ [blue,      solid, opacity=0.7             ] table [x=muQ, y=ne] {../code/data/LSM3F/eos_sigma_700.dat}; \addlegendentry{$n_e$ (electrons)};
\addplot+ [blue,      solid, opacity=0.7, forget plot] table [x=muQ, y=ne] {../code/data/LSM3F/eos_sigma_800.dat};
\addplot+ [purple,    solid, opacity=0.7             ] table [x=muQ, y=ns] {../code/data/LSM3F/eos_sigma_700.dat}; \addlegendentry{$n_s$ (strange quarks)};
\addplot+ [purple,    solid, opacity=0.7, forget plot] table [x=muQ, y=ns] {../code/data/LSM3F/eos_sigma_800.dat};
\addplot+ [darkgreen, solid, opacity=0.7             ] table [x=muQ, y=nd] {../code/data/LSM3F/eos_sigma_700.dat}; \addlegendentry{$n_d$ (down quarks)};
\addplot+ [darkgreen, solid, opacity=0.7, forget plot] table [x=muQ, y=nd] {../code/data/LSM3F/eos_sigma_800.dat};
\addplot+ [red,       solid, opacity=0.7             ] table [x=muQ, y=nu] {../code/data/LSM3F/eos_sigma_700.dat}; \addlegendentry{$n_u$ (up quarks)};
\addplot+ [red,       solid, opacity=0.7, forget plot] table [x=muQ, y=nu] {../code/data/LSM3F/eos_sigma_800.dat};
