...
\TODO{mention coupling to chemical potential}
...
With massless quarks, the Lagrangian can be written
\begin{equation}
	%\lagr = i \bar{u}_- \gamma^\mu D_\mu u_- + i \bar{u}_+ \gamma^\mu D_\mu u_+ + i \bar{d}_- \gamma^\mu D_\mu d_- + i \bar{d}_+ \slashed{D} d_+ - \frac14 G_{\mu\nu}^a G^{\mu\nu}_a.
