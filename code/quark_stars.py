...
if __name__ == "__main__":
    ...
    #Hybrid2FlavorConsistentModel(mσ=400).stars(107, (1e-5, 1e-2), write=True) # use tolD=0.01
    #Hybrid2FlavorConsistentModel(mσ=500).stars(84,  (1e-5, 1e-2), write=True) # use tolD=0.01
    #Hybrid2FlavorConsistentModel(mσ=600).stars(27,  (1e-5, 1e-2), write=True) # use tolD=0.01
