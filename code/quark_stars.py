...
def μelim(σ, μu, neutral, side, μdmax=1e5, verbose=False, ftol=0):
...
def eos(neutral, μside, name="ϵ"):
    μu = np.linspace(0, 1e4, 500)
...
opts = { "tolD": 0.05, "tolP": 1e-5, "maxdr": 1e-3, "Psurf": 0, "visual": True }
massradiusplot(ϵ1, (1e-1, 1e4), **opts, nmodes=0)
